<properties
	...
	description="取得 Apache Storm 的一般用途介紹，並了解如何使用 Apache Storm on HDInsight 在雲端中建置即時資料分析解決方案。"
...
如需關於使用 Storm 儀表板的詳細資訊，請參閱[部署和管理 HDInsight 上的 Apache Storm 拓撲](hdinsight-storm-deploy-monitor-topology.md){b>。<b}
