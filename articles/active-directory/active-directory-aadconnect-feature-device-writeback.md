...
>[AZURE.IMPORTANT]
<li>裝置必須位於使用者所在的樹系中。由於裝置必須回寫到單一樹系中，因此這項功能目前並不支援利用多重使用者樹系的部署。</li> <li>只有一個裝置註冊設定物件可被新增到內部部署 Active Directory 樹系中。這項功能與會將內部部署 Active Directory 同步至多個 Azure AD 目錄的拓撲不相容。</li>
