...
>[AZURE.NOTE]
Get-Credential 快顯視窗顯示時輸入的認證使用者名稱必須採用 **user@example.com* 格式
...
>[AZURE.NOTE]
此群組原則範本在 Windows 10 中已重新命名。如果您從 Windows 10 電腦執行群組原則工具，原則將會顯示為：<br> [註冊加入網域的電腦為裝置]，且原則將會位於下列位置之下：<br> 電腦設定/原則/系統管理範本 /Windows 元件/裝置註冊
