...
## 密碼管理報告
 ...
 > **答：**密碼管理報表中可儲存最多 1,000 個密碼重設或密碼重設註冊事件。我們正在擴展此數目，以包含更多的事件。
 ...
 > **答：**是，請參閱下列文件以了解如何存取密碼重設報告資料串流。[了解如何以程式設計方式存取密碼重設報告事件](https://msdn.microsoft.com/library/azure/mt126081.aspx#BKMK_SsprActivityEvent)。
