...
7.  在結果窗格中，選取 [15Five]，然後按一下 [完成] 以加入應用程式。
...
4.  於 [在 15Five 設定單一登入] 頁面上，按一下 [下載中繼資料]，然後將中繼資料檔轉寄給 15Five 支援小組。
...
4.  在 [新增人員] 區段中，執行下列步驟：
    ...
    1.  在相關的文字方塊中，輸入您要佈建之有效 Azure Active Directory 帳戶的 [名字]、[姓氏]、[職稱]、[電子郵件地址]。
    2.  按一下 [完成]。
