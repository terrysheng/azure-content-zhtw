...
4. 若要開啟 [加入使用者] 對話方塊，請按一下底部工具列上的 [加入使用者]。<br><br> ![建立 Azure AD 測試使用者](./media/active-directory-saas-23video-tutorial/create_aaduser_04.png) <br>
...
4. 在 [邀請人員加入此站台] 區段中，執行下列步驟：<br><br>![指派使用者][402]<br>
...
本節目標是使用存取面板測試您的 Azure AD 單一登入組態。<br> 當您在存取面板中按一下 [23 Video] 磚時，應該會自動登入您的 23 Video 應用程式。
