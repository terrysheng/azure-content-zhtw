...
本教學課程的目標是說明如何將 CS Stars 與 Azure Active Directory (Azure AD) 整合。<br>將 CS Stars 與 Azure AD 整合可為您提供下列好處：
...
6. 在搜尋方塊中，輸入**CS Stars**。<br><br>![應用程式][5]<br>

7. 在結果窗格中，選取 [CS Stars]，然後按一下 [完成] 以加入應用程式。<br><br>![應用程式][400]<br>
...
若要讓單一登入運作，Azure AD 必須知道 CS Stars 與 Azure AD 中互相對應的使用者。換句話說，必須在 Azure AD 使用者和 CS Stars 中的相關使用者之間建立連結關聯性。<br> 建立此連結關聯性的方法是將 Azure AD 中**使用者名稱**的值指定為 CS Stars 中 **Username** 的值。
...
本節目標是在 Azure 傳統入口網站啟用 Azure AD 單一登入，並在您的 CS Stars 應用程式中設定單一登入。<br>

**若要使用 CS Stars 設定 Azure AD 單一登入，請執行下列步驟：**

1. 在 Azure 傳統入口網站的 [CS Stars] 應用程式整合頁面上，按一下 [設定單一登入] 來開啟 [設定單一登入] 對話方塊。<br><br>![設定單一登入][6]<br>

2. 在 [您希望使用者如何登入 CS Stars] 頁面上，選取 [Azure AD 單一登入]，然後按 [下一步]。<br><br>![Azure AD 單一登入][7]<br>

3. 在 [設定 App 設定] 對話方塊頁面執行下列步驟：<br><br>![設定 App 設定][8]<br>
...
4. 於 [在CS Stars 設定單一登入] 頁面上，按 [下載中繼資料]，然後將中繼資料檔儲存在您的本機電腦中。<br><br>![何謂 Azure AD Connect][9]<br>
...
7. 在 [單一登入確認] 頁面上，按一下 [完成]。<br><br>![何謂 Azure AD Connect][11]<br>
...
1. 在 **Azure 傳統入口網站**中，按一下左方瀏覽窗格中的 [Active Directory]。<br><br>![建立 Azure AD 測試使用者](./media/active-directory-saas-amazon-web-service/create_aaduser_02.png)<br> 
...
本節目標是授與 Britta Simon 對 CS Stars 的存取權，讓她能夠使用 Azure 單一登入。<br><br>![指派使用者][200]<br>

**若要將 Britta Simon 指派到 CS Stars，請執行以下步驟：**

1. 在 Azure 傳統入口網站中，若要開啟應用程式檢視，請在目錄檢視中，按一下頂端功能表中的 [應用程式]。<br><br>![指派使用者][201]<br>
2. 在應用程式清單中，選取 [CS Stars]。<br><br>![指派使用者][202]<br>
1. 在頂端的功能表中，按一下 [使用者]。<br> <br><br>![指派使用者][203]<br>
1. 在 [使用者] 清單中，選取 [Britta Simon]。

2. 在底部的工具列中，按一下 [指派]。<br><br>![指派使用者][205]<br>



### 測試單一登入

本節目標是使用存取面板來測試您的 Azure AD 單一登入組態。<br> 當您在存取面板中按一下 [CS Stars] 磚時，應該會自動登入您的 CS Stars 應用程式。
