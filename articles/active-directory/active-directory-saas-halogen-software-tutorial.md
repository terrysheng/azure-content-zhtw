...
3. 在 [設定 App 設定] 對話方塊頁面執行下列步驟：<br><br>![設定 App 設定][10]
     ...
     a. 在 [登入 URL] 文字方塊中，使用下列形式輸入使用者登入您的 Halogen Software 應用程式時所使用的 URL：**https://global.hgncloud.com/fabrikam/welcome.jsp*
...
5. 在 [告訴我們這位使用者] 對話方塊頁面上，執行下列步驟：<br><br>![何謂 Azure AD Connect][103] 
...
3. 在 [新增使用者] 對話頁面上，執行下列步驟：<br><br>![何謂 Azure AD Connect][301] a.在 [名字] 文字方塊中，輸入 **Britta**。b.在 [姓氏] 文字方塊中，輸入 **Simon**。c.在 [使用者名稱] 文字方塊中輸入 **Brita Simon 在 Azure AD 入口網站的使用者名稱**。d.在 [密碼] 文字方塊中輸入 Britta 的密碼。e.按一下 [儲存]。
