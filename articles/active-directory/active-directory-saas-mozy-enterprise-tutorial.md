...
完成本教學課程之後，您指派給 Mozy Enterprise 的 Azure AD 使用者就能夠單一登入您 Mozy Enterprise 公司網站 (服務提供者起始登入) 的應用程式，或是使用[存取面板簡介](active-directory-saas-access-panel-introduction.md)進行單一登入。
...
7.  在 [驗證原則] 區段中，執行下列步驟：
    ...
    5.  在 Azure 入口網站上 [設定在 Mozy Enterprise 單一登入] 對話方塊頁面，複製 [身分識別提供者 ID] 值，然後將它貼至 [SAML 端點] 文字方塊中。
    6.  從您下載的憑證建立 **Base-64 編碼**檔案。  

        >[AZURE.TIP]如需詳細資訊，請參閱[如何將二進位憑證轉換成文字檔](http://youtu.be/PlgrzUZ-Y1o)

    7.  在記事本中開啟您的 base-64 編碼的憑證，將它的內容複製到您的剪貼簿，然後將整個憑證貼至 [SAML 憑證] 文字方塊。
