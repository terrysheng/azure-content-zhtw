...
完成本教學課程或使用[存取面板簡介](active-directory-saas-access-panel-introduction.md)之後，您指派給 Panopto 的 Azure AD 使用者就能夠單一登入您 Panopto 公司網站 (服務提供者起始登入) 的應用程式。
...
5.  在 [欲執行動作] 對話方塊中，按一下 [從資源庫中新增應用程式]。
    ...
    ![從組件庫新增應用程式](./media/active-directory-saas-panopto-tutorial/IC749322.png "從資源庫中新增應用程式")
...
1.  在 Azure AD 入口網站的 **Panopto** 應用程式整合頁面中，按一下 [設定單一登入] 來開啟 [設定單一登入] 對話方塊。

    ![設定單一登入](./media/active-directory-saas-panopto-tutorial/IC777667.png "設定單一登入")

2.  在 [要如何讓使用者登入 Panopto] 頁面上，選取 [Microsoft Azure AD 單一登入]，然後按 [下一步]。

    ![設定單一登入](./media/active-directory-saas-panopto-tutorial/IC777668.png "設定單一登入")

3.  在 [設定應用程式 URL] 頁面上，於 [Panopto 登入 URL] 文字方塊中，使用下列模式輸入您的 URL："*https://\<tenant-name>。Panopto.com*"，然後按 [下一步]。
...
7.  按一下 新增提供者]。
    ...
    ![身分識別提供者](./media/active-directory-saas-panopto-tutorial/IC777671.png "識別提供者")

8.  在 [SAML 提供者] 區段中，執行下列步驟：

    ![SssS 組態](./media/active-directory-saas-panopto-tutorial/IC777672.png "SssS 組態")

    1.  從 [提供者類型] 清單選取 [SAML20]
    2.  在 [執行個體名稱] 文字方塊中，輸入執行個體的名稱。
    3.  在 [好記的描述] 文字方塊中，輸入好記的描述。
    4.  在 Azure 入口網站的 [設定在 Panopto 單一登入] 對話方塊頁面中，複製**簽發者 URL** 值，然後將它貼至 [簽發者] 文字方塊中。
    5.  在 Azure 入口網站的 [設定在 Panopto 單一登入] 對話方塊頁面中，複製 **SAML SSO URL** 值，然後將它貼至 [彈跳頁面 URL] 文字方塊中。
    6.  從您下載的憑證建立 **Base-64 編碼**檔案。  

        >[AZURE.TIP]如需詳細資訊，請參閱[如何將二進位憑證轉換成文字檔](http://youtu.be/PlgrzUZ-Y1o)

    7.  在記事本中開啟您的 Base-64 編碼的憑證，將其內容複製到剪貼簿，然後貼到 [公開金鑰] 文字方塊
