...
8.  在 [使用 SAML 登入] 對話方塊頁面上，執行下列步驟，然後按一下 [儲存變更]：
    ...
    2.  在 Azure 入口網站中的 [設定在 Samanage 單一登入] 對話頁面上，複製 [識別提供者 ID] 值，然後將其貼至 [識別提供者 URL] 文字方塊中。![設定單一登入](./media/active-directory-saas-samanage-tutorial/IC771720.png "設定單一登入")
