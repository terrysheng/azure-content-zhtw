<properties pageTitle="教學課程：Azure Active Directory 與 Slack 整合 | Microsoft Azure" description="了解如何使用 Slack 搭配 Azure Active Directory 來啟用單一登入、自動化佈建和更多功能！" services="active-directory" authors="MarkusVi"  documentationCenter="na" manager="stevenpo"/>
<tags ms.service="active-directory" ms.devlang="na" ms.topic="article" ms.tgt_pltfrm="na" ms.workload="identity" ms.date="08/01/2015" ms.author="markvi" />
#教學課程：Azure Active Directory 與 Slack 整合
>[AZURE.TIP]如需意見反應，請按一下[這裡](http://go.microsoft.com/fwlink/?LinkId=536424)。
...
完成本教學課程之後，您指派給 Slack 的 Azure AD 使用者就能夠單一登入您 Slack 公司網站 (服務提供者起始登入) 的應用程式，或是使用[存取面板簡介](https://msdn.microsoft.com/library/dn308586)進行單一登入。
...
1.  在 Azure AD 入口網站的 [Slack] 應用程式整合頁面上，按一下 [設定單一登入] 開啟 [設定單一登入] 對話方塊。
...
8.  在 [SAML 驗證設定] 對話方塊上，執行下列步驟：
    ...
    1.  在 Azure 入口網站的 [設定在 Slack 單一登入] 對話頁面上，複製 [SAML SSO URL] 值，然後將它貼至 [SAML 2.0 端點 (HTTP)] 文字方塊中。
    2.  在 Azure 入口網站中的 [設定在 Slack 單一登入] 對話頁面上，複製 [簽發者 URL] 值，然後將它貼至 [識別提供者簽發者] 文字方塊中。
