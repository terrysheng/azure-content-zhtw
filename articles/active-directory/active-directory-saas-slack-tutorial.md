<properties 
    ...
    description="了解如何使用 Slack 搭配 Azure Active Directory 來啟用單一登入、自動化佈建和更多功能！" 
...
完成本教學課程或使用[存取面板簡介](active-directory-saas-access-panel-introduction.md)之後，您指派給 Slack 的 Azure AD 使用者就能夠單一登入您 Slack 公司網站 (服務提供者起始登入) 的應用程式。
...
7.  在結果窗格中，選取 [Slack]，然後按一下 [完成] 新增應用程式。
...
1.  在 Azure AD 入口網站的 **Slack** 應用程式整合頁面中，按一下 [設定單一登入] 開啟 [設定單一登入] 對話方塊。
...
3.  在 [設定應用程式 URL] 頁面上，於 [Slack 登入 URL] 文字方塊中，輸入您的 Slack 租用戶 URL (例如："**https://azuread.slack.com*"))，然後按 [下一步]。
...
8.  在 [SAML 驗證設定] 對話方塊上，執行下列步驟：
    ...
    1.  在 Azure 入口網站的 [設定在 Slack 單一登入] 對話方塊頁面中，複製 **SAML SSO URL** 值，然後將它貼至 [SAML 2.0 端點 (HTTP)] 文字方塊中。
    2.  在 Azure 入口網站的 [設定在 Slack 單一登入] 對話方塊頁面中，複製**簽發者 URL** 值，然後將它貼至 [識別提供者簽發者] 文字方塊中。
    3.  從您下載的憑證建立 **Base-64 編碼**檔案。
    
        >[AZURE.TIP]如需詳細資訊，請參閱[如何將二進位憑證轉換成文字檔](http://youtu.be/PlgrzUZ-Y1o)

    4.  在記事本中開啟您的 Base-64 編碼的憑證，將其內容複製到剪貼簿，然後貼到 [公開憑證] 文字方塊。
