<properties 
    ...
    description="了解如何使用 Thoughtworks Mingle 搭配 Azure Active Directory 來啟用單一登入、自動化佈建和更多功能！" 
...
7.  在結果窗格中，選取 [Thoughtworks Mingle]，然後按一下 [完成] 以加入應用程式。
...
2.  在 [要如何讓使用者登入 Thoughtworks Mingle] 頁面上，選取 [Microsoft Azure AD 單一登入]，然後按 [下一步]。
...
4.  於 [在 Thoughtworks Mingle 設定單一登入] 頁面上，按一下 [下載中繼資料]，然後將其儲存在您的電腦中。
