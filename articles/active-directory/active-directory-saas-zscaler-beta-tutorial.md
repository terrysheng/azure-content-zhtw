<properties 
    ...
    description="了解如何使用 Zscaler Beta 搭配 Azure Active Directory 來啟用單一登入、自動化佈建和更多功能！" 
...
完成本教學課程之後，您指派給 ZScaler Beta 的 Azure AD 使用者就能夠單一登入您 ZScaler Beta 公司網站 (服務提供者起始登入) 的應用程式，或是使用[存取面板簡介](active-directory-saas-access-panel-introduction.md)進行單一登入。
