<properties
   ...
   description="在 Azure Active Directory 中啟用 SaaS 應用程式的單一登入驗證和使用者佈建集中式存取管理"
...
對於您在應用程式資源庫中找到的 SaaS 應用程式，Azure Active Directory 提供一些[有關如何整合 SaaS 應用程式的教學課程](active-directory-saas-tutorial-list.md)。

如果應用程式不在應用程式資源庫中，您可以[將應用程式新增至 Azure Active Directory 應用程式資源庫做為自訂應用程式](http://blogs.technet.com/b/ad/archive/2015/06/17/bring-your-own-app-with-azure-ad-self-service-saml-configuration-gt-now-in-preview.aspx)。
