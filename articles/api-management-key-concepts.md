...
如需詳細資訊，請參閱[如何建立和發行產品][如何建立和發行產品]。
...
-   **開發人員** - 開發人員是使用您的 API 建置應用程式的客戶。開發人員獲授與[開發人員入口網站][開發人員入口網站]的存取權，並建置呼叫 API 作業的應用程式。
...
如需 API 管理原則的完整清單，請參閱[原則參考文件][原則參考文件]。如需使用和設定原則的詳細資訊，請參閱 [API 管理原則][API 管理原則]。如需建立產品並加上費率限制和配額原則的教學課程，請參閱[如何建立和設定進階產品設定][如何建立和設定進階產品設定]。
