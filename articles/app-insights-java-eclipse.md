...
![伺服器回應、要求計數和失敗](./media/app-insights-java-track-http-requests/5-results.png)
 

逐一點選任何圖表以查看更詳細的度量。

![依名稱的要求計數](./media/app-insights-java-track-http-requests/6-barchart.png)
...
![此要求的所有追蹤](./media/app-insights-java-track-http-requests/7-instance.png)
...
![工作階段、使用者和頁面檢視](./media/appinsights/appinsights-47usage-2.png)
...
![Web 測試範例](./media/appinsights/appinsights-10webtestresult.png)
