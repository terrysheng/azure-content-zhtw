...
如果您已開始對此 Web 應用程式[監視使用情形和健全狀況][]，且想要在同樣的地方查看可用性資料，請跳過此步驟。
...
![Click the empty availability test][]
...
![On the web tests blade, choose Add][]
