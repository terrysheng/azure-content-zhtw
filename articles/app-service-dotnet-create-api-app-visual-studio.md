...
本教學課程顯示如何採取現有的 Web API 專案，並為了部署而將它設定為 [Azure App Service](app-service-value-prop-what-is.md) 中的 [API 應用程式](app-service-api-apps-why-best-platform.md)。系列中的後續教學課程顯示如何[部署](app-service-dotnet-deploy-api-app.md)和[偵錯](app-service-dotnet-remotely-debug-api-app.md)您已在本教學課程中建立的 API 應用程式專案。
