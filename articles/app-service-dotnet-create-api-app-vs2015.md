...
在本教學課程中，您將使用 Visual Studio 2015 建立 ASP.NET Web API 2 專案，並設定它以部署到雲端，做為 [Azure App Service](app-service-value-prop-what-is.md) 中的 [API 應用程式](app-service-api-apps-why-best-platform.md)。您也會將專案部署至 Azure。在本教學課程的結尾，您將會在 Azure 雲端中執行 API 應用程式。
