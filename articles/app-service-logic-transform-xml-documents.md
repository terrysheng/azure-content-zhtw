...
2.	選取 [**新增**] > [**Web + 行動**] > [**Azure Marketplace**] > [**API 應用程式**]：
	...
	或者，您可以選取 [儀表板] 上的 [**Marketplace**]，然後從可用的清單中選取 [**API 應用程式**]：
...
1.	在 Azure 管理入口網站上選取 [**瀏覽**] \(螢幕的左側)，然後選取 [**API 應用程式**]。如果 [**API 應用程式**] 未顯示，請選取 [**全部**]，然後從可用的清單中選取 [**API 應用程式**]：

	![][7]

2.	所有在您的 Azure 訂用帳戶中建立的 [**API 應用程式**] 都會顯示：

	![][8]

3.	選取您在上一節中建立的 BizTalk 轉換 API 應用程式。

4.	API 應用程式的設定分頁隨即開啟。您可以在 [元件] 區段中檢視 [**對應**]：
