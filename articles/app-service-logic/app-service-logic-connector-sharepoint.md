...
>[AZURE.NOTE] 這一版的文章適用於邏輯應用程式 2014-12-01-preview 結構描述版本。若為 SharePoint Online API 上的 2015-08-01-preview 結構描述版本，請按一下 [SharePoint API](../connectors/connectors-create-api-sharepointonline.md)。
