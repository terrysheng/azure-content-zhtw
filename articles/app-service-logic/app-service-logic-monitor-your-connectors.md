...
>[AZURE.NOTE] 如果您想要在註冊 Azure 帳戶之前先開始使用 Azure Logic Apps，請移至[試用 Logic Apps](https://tryappservice.azure.com/?appservice=logic)。您可以在 App Service 中建立短期的入門邏輯應用程式。不需要信用卡，無需承諾。
...
[Microsoft Azure 入口網站中以角色為基礎的存取控制](role-based-access-control-configure.md)<br/>
