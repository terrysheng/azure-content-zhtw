...
我們已經實作了下列 B2B 實例的訊息追蹤：AS2、EDIFACT 和 X12。

## AS2
在您建立 AS2 API 應用程式的執行個體後，您可以瀏覽至該執行個體，然後選取 [追蹤]。在此處，您將可檢視和篩選所有 AS2 追蹤資訊

![][1]

## EDIFACT
在您建立 EDIFACT API 應用程式的執行個體後，您可以瀏覽至該執行個體，然後選取 [追蹤]。在此處，您將可檢視和篩選所有 EDIFACT 追蹤資訊。此外，您將能夠檢視交換層級、群組層級和交易集層級資料，全在單一檢視畫面中。
...
## X12
在您建立 X12 API 應用程式的執行個體後，您可以瀏覽至該執行個體，然後前往 [追蹤]。在此處，您將可檢視和篩選所有 X12 追蹤資訊。此外，您將能夠檢視交換層級、群組層級和交易集層級資料，全在單一檢視畫面中。
