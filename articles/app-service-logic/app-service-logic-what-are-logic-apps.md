...
此外，透過 [BizTalk API 應用程式][biztalk]，您可以利用[規則引擎][rules]、[交易夥伴管理][tpm]等的功能，擴展至成熟的整合案例。
...
- **從範本快速開始使用** - 為了方便您著手使用，我們提供[範本庫][templates]，讓您可快速建立一些常見的解決方案。從進階 BizTalk 解決方案到簡單的 SaaS 連線 (甚至只為了「好玩」) - 組件庫是了解邏輯應用程式強大功能的最快方式。
