...
Azure App Service 是專為專業開發人員提供的完全受管理的平台即服務 \(PaaS\)，具有一組豐富的功能可供 Web、行動和整合案例使用。*Azure App Service* 中的 *行動應用程式* 是專為企業開發人員與系統整合人員提供的可高度擴充、全域使用的行動應用程式開發平台，具有一組豐富的功能可供行動應用程式使用。
