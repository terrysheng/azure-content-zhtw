...
1. 在您的電腦上瀏覽 [Azure 入口網站]。按一下 [瀏覽全部] > [Mobile Apps]，然後按一下您剛才建立的行動應用程式後端。
...
4. 按 **F5** 鍵以建置專案，並在 iPhone 模擬器中啟動應用程式。
...
6. 按 **F5** 鍵以建置專案，並在 Android 模擬器中啟動應用程式。
...
6. 按 **F5** 鍵以建置專案，並在 Windows 模擬器中啟動應用程式。
