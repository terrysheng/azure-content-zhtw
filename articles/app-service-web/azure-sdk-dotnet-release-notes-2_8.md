...
Azure.NET SDK 2.8 可讓您建立 .NET 4.5.2 雲端服務套件。不過，.NET 4.5.2 Framework 要到 2016 年 1 月的客體作業系統版本，才會安裝在預設的客體作業系統映像上。在這之前，可以透過獨立的客體作業系統版本 November 2015-02 取得 .NET 4.5.2 Framework。請參閱 [Azure 客體 OS 版本與 SDK 相容性矩陣](../cloud-services-guestos-update-matrix.md)頁面以追蹤該映像何時發行。一旦 November 2015-02 映像發行，您便可選擇透過更新您的雲端服務組態檔 (.cscfg) 來使用該映像。在服務組態檔中，將 ServiceConfiguration 項目的 osVersion 屬性設定為字串 "WA-GUEST-OS-4.26\_201511-02"。如果您選擇加入以使用此映像，那麼您將不會再收到客體 OS 的自動更新。若要取得自動更新，osVersion 必須設為 “*”，且 .NET 4.5.2 將只能在 2016 年 1 月透過自動更新取得。
