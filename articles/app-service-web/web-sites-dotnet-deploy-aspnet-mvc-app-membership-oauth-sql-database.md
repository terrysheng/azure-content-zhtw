...
1. 按一下 [發行 Web] 對話方塊左側的 [設定] 索引標籤。按一下 [**v**] 圖示以選取 [**ApplicationDbContext**] 的 [**遠端連接字串**]，並選取 [**ContactManagerNN\_db**]。
