...
>[AZURE.NOTE]如果您需要設定應用程式閘道的自訂探查，請移至[如何使用 PowerShell 建立具有自訂探查的應用程式閘道](application-gateway-create-probe-ps.md)一文。參閱[自訂探查和健康狀況監視](application-gateway-probe-overview.md)以取得詳細資訊。
