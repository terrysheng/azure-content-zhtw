<properties
   ...
   description="建立、設定、啟動和刪除 Azure 應用程式閘道"
...
如果您想要刪除應用程式閘道，請參閱[刪除應用程式閘道](#delete-an-application-gateway)。
...
> [AZURE.NOTE]`Start-AzureApplicationGateway` Cmdlet 最多可能需要 15 到 20 分鐘的時間才能完成。
