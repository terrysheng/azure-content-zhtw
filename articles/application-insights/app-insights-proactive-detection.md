...
我們熱切期待您的意見反應。請告訴我們如何讓產品協助您、如何改進主動偵測，以及希望我們加入哪些額外的功能。您可以透過入口網站中的 [傳送笑臉/哭臉] 提供意見反應，或寄送電子郵件至 AppInsightsML@microsoft.com。
 ...
 * 在應用程式的 Application Insights 概觀中，按一下 [主動式偵測] 磚。您可以在這裡找到最多 7 天前的所有通知。
