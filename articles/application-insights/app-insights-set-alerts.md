...
![在 [警示規則] 分頁中，按一下 [新增警示]。將您的應用程式設定為要測量的資源，提供警示的名稱，然後選擇度量。](./media/app-insights-set-alerts/01-set-metric.png)
...
![在 [概觀] 分頁靠近底部的位置，按一下 [過去一週的事件]](./media/app-insights-set-alerts/09-alerts.png)
