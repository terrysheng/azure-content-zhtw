...
[下載 Azure 符號/圖示集](http://www.microsoft.com/download/details.aspx?id=41937)以建立說明 (或使用) Azure 的技術資料，如架構圖、訓練資料、簡報、資料工作表、資訊圖及技術白皮書等等。您可以下載 PPT、Visio 或 PNG 格式的符號。我們想要知道您的想法，因此下載中有些關於如何提供意見反應的指示。
