...
可透過 [Windows MSOnlineBackup 模組](https://technet.microsoft.com/en-us/library/hh770400.aspx)中提供的 PowerShell Cmdlet，在 Azure 自動化中管理備份。Azure 自動化可以呼叫這些 PowerShell 指令程式，因此您可以在服務內執行所有的備份管理工作。您也可以在 Azure 自動化中將這些 Cmdlet 與其他 Azure 服務的 Cmdlet 配對，將跨 Azure 服務和協力廠商系統的複雜工作自動化。
