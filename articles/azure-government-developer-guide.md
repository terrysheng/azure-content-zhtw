...
<p> Microsoft Azure Government 是 Microsoft Azure 的實體及網路隔離執行個體。此開發人員指南將針對應用程式開發人員和系統管理員需要與這些 Azure 個別地區互動及處理的差異，提供相關提供詳細資料。
...
本文件中的資訊將概述這些差異，並以 [Azure Government](http://www.azure.com/gov "Azure Government") 站台及 MSDN 上 [Microsoft Azure 技術文件庫](http://msdn.microsoft.com/cloud-app-development-msdn "MSDN")中提供的資訊做補充。正式資訊也可以在其他許多位置中找到，例如 [Microsoft Azure 信任中心](http://azure.microsoft.com/support/trust-center/ "Microsoft Azure Trust Center")、[Azure 文件中心](http://azure.microsoft.com/documentation/)及 [Azure 部落格](http://azure.microsoft.com/blog/ "Azure Blogs")。 
...
- 首先，有服務和功能差異，這表示「全域服務」特定地區中的某些功能可能無法在 Azure Government 中提供。
...
Azure Government 目前在在「美國政府愛荷華州」(US GOV IOWA) 及「美國政府維吉尼亞州 (US GOV VIRGINIA)」地區有下列可用的服務：
...
有其他服務可用，並且會持續新增更多服務。如需最新的服務清單，請參閱[地區頁面](http://azure.microsoft.com/regions/#services)，當中將醒目提示每個可用的地區及其服務。  

目前，「美國政府愛荷華州」和「美國政府維吉尼亞州」是支援 Azure Government 的資料中心。如需目前的資料中心及可用的服務，請參閱上述地區頁面。
...
運算	</td><td>*.cloudapp.net	</td><td>*.usgovcloudapp.net
</td></tr><tr><td>
