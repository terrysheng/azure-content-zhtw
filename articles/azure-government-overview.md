...
Azure Government 是一個政府社群雲端 (GCC)，設計來支援美國政府機構需要速度、大規模、安全性、法務遵循與高經濟效益的策略性政府狀況。   它是根據 Microsoft 在其他 Microsoft 雲端產品中 (例如 Azure Public、Office 365、O365 GCC，Microsoft CRM Online 等等) 提供軟體、安全性、法務遵循與控制項方面豐富的經驗所開發。 
...
以下是 Azure Government 可用來協助政府組織建置混合式雲端解決方案，以滿足其目標的雲端基礎結構、網狀架構、服務和架構。因為下列部分服務只於預覽版中提供，請參閱[地區頁面](http://azure.microsoft.com/regions/#services)中所列出之可用的最新服務。
...
- **資料儲存** - Azure Government 環境維護 2 個距離超過 500 英哩遠的資料中心。所有客戶管理資料都存放於美國本土 (CONUS) 的資料中心
...
## <a name="Features"></a>Microsoft Azure Government 目前可用的功能
Azure Government 目前在「美國政府愛荷華州」(US GOV IOWA) 及「美國政府維吉尼亞州 (US GOV VIRGINIA)」地區有下列可用的服務：
...
有其他服務可用，並且會持續新增更多服務。如需服務的最新清單，請參閱[地區頁面](http://azure.microsoft.com/regions/#services)中醒目提示的每個可用地區及其服務。  
