...
**Q10.若重新命名正在將資料備份至 Azure 的 Windows 伺服器，則會發生什麼情況？** <br/> A10.任何目前已設定的備份將會停止。您需要使用備份保存庫重新註冊伺服器，且復原服務會將其視為新的伺服器，因此註冊後進行的第一次備份作業，將會是包含在備份中所有資料的完整備份，而非僅包含自上次進行備份後的變更。不過，如果您需要執行復原作業，您可以使用復原服務，從其他伺服器復原選項來復原已備份的資料。
