...
## 步驟 1：建立 Azure 訂用帳戶
+ 如果您沒有 Azure 訂用帳戶，您可以使用能存取任何 Azure 服務的免費試用優惠。若要深入了解，請瀏覽 [http://azure.microsoft.com/en-us/pricing/free-trial-faq/](http://azure.microsoft.com/en-in/pricing/free-trial)。
