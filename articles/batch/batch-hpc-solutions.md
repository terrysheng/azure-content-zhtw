...
>[AZURE.NOTE]新服務會定期導入 Azure 平台，且可能適用於您的案例。建議僅將預覽服務運用於測試或證明概念部署，而非生產工作負載。如果您有疑問，請連絡 [Azure 合作夥伴](https://pinpoint.microsoft.com/en-US/search?keyword=azure)或寄電子郵件到 *bigcompute@microsoft.com*。
