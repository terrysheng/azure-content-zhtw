<properties
	...
	description="了解適用於大規模的平行和 HPC 工作負載之 Azure Batch 服務"
	services="batch"
	documentationCenter=""
	authors="dlepow"
	manager="timlt"
...
Batch 也可以執行平行計算 (最後加上歸納步驟)，以及其他更複雜的 HPC 工作負載，例如訊息傳遞介面 (MPI) 應用程式。
...
+ **Azure 帳戶和訂用帳戶** -如果您沒有這類帳戶，可以啟用自己的 [MSDN 訂戶權益](https://azure.microsoft.com/pricing/member-offers/msdn-benefits-details/)或是申請[免費試用](https://azure.microsoft.com/pricing/free-trial/)。
