...
* [影片：Azure 批次簡介](http://azure.microsoft.com/documentation/videos/introduction-to-azure-batch-with-mark-scurrell/)

* [影片：由 Mark Russinovich 示範 Azure 批次服務](http://azure.microsoft.com/documentation/videos/azure-batch-demo-blender/)

* [影片：建置批次服務](http://azure.microsoft.com/documentation/videos/azure-batch-build-a-batch-service/)
...
* [Azure 的批次程式碼範例](https://code.msdn.microsoft.com/site/search?f[0].Type=Topic&f[0].Value=Azure%20Batch&f[0].Text=Azure%20Batch)
