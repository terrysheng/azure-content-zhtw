...
2. 在 [**按一下訂用帳戶即可檢視詳細資料及使用量**] 下方，選取要驗證付款方法的訂用帳戶。
...
如果您設定信用卡或金融卡作為付款方法，系統將會自動扣款。如果要能夠隨時變更卡片，請參閱 [如何變更 Azure 訂用帳戶的付款方法或信用額度](../billing-how-to-change-credit-card.md)。

如果您使用發票付款方法，請將您的付款交付至您發票底部所列的位置。如需其他協助，請聯絡 [Microsoft 支援](https://ms.portal.azure.com/#blade/Microsoft_Azure_Support/HelpAndSupportBlade)。
