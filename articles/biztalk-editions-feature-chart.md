<properties urlDisplayName="Editions chart" pageTitle="了解 BizTalk 服務各版本的功能 | Azure" metaKeywords="BizTalk Services, get started, Azure, editions" description="比較 BizTalk Services 版本的功能：免費、開發人員、基本、標準和高級。" metaCanonical="" services="biztalk-services" documentationCenter="" title=" Basic" authors="mandia" solutions="" manager="dwrede" editor="cgronlun" />
...
<td>請參閱 <a HREF="http://go.microsoft.com/fwlink/p/?LinkID=304011">BizTalk 服務定價詳細資料</a>。</td>
<td>請參閱 <a HREF="http://go.microsoft.com/fwlink/p/?LinkID=304011">BizTalk 服務定價詳細資料</a>。</td>
<td>請參閱 <a HREF="http://go.microsoft.com/fwlink/p/?LinkID=304011">BizTalk 服務定價詳細資料</a>。</td>
<td>請參閱 <a HREF="http://go.microsoft.com/fwlink/p/?LinkID=304011">BizTalk 服務定價詳細資料</a>。</td>
<td>請參閱 <a HREF="http://go.microsoft.com/fwlink/p/?LinkID=304011">BizTalk 服務定價詳細資料</a>。</td>
...
<tr>
<td><strong>內部部署 LOB 系統的 BizTalk 介面卡服務連接</strong></td>
<td>未包括</td>
<td>1 個連接</td>
<td>2 個連接</td>
<td>5 個連接</td>
...
<br/><br/>
有關服務等級協定 (SLA)，請參閱 <a HREF="http://go.microsoft.com/fwlink/p/?LinkID=304011"> Azure BizTalk 服務定價詳細資料</a>。
</td>
<td>未包括</td>
<td>未包括</td>
<td>已包括</td>
...
**注意**
<br/>針對硬體故障時的備援能力，高可用性即代表在單一 BizTalk 單位內具有多個 VM。

## 常見問題集
#### 何謂 BizTalk 單位？
「單位」為 Azure BizTalk 服務部署的最小層級。每個版本都隨附一個具有不同計算容量和記憶體的單位。例如，基本單位的計算能力超過開發人員、標準的計算能力超過基本，依此類推。當調整 BizTalk 服務時，您是根據單位調整。
...
虛擬機器上的 BizTalk 伺服器提供基礎架構即服務 (IaaS) 架構。您可以建立虛擬機器，並設定它們完全和您的內部部署環境一樣，這使得在雲端中執行現有的應用程式更為容易，而不需變更程式碼。使用 IaaS 時，您仍須負責設定虛擬機器、管理虛擬機器 (例如，安裝軟體和修補程式)，以及  架構高可用性的應用程式。 
...
使用備份與還原流程，從某層移轉至另一層。僅支援某些移轉路徑。請參閱 [BizTalk 服務：備份與還原](http://go.microsoft.com/fwlink/p/?LinkID=329873)，以取得支援的移轉路徑的詳細資料。
...
若要在 Azure 管理入口網站中佈建 Azure BizTalk 服務，請移至 [BizTalk 服務：使用 Azure 管理入口網站進行佈建](http://go.microsoft.com/fwlink/p/?LinkID=302280) (英文)。若要開始建立應用程式，請移至 [Azure BizTalk 服務](http://go.microsoft.com/fwlink/p/?LinkID=235197)。
