...
<td data-morhtml="true"><strong data-morhtml="true">說明</strong></td>
<td data-morhtml="true"><strong data-morhtml="true">低閾值</strong></td>
<td data-morhtml="true"><strong data-morhtml="true">高閾值</strong></td>
</tr>
    <tr data-morhtml="true">
<td data-morhtml="true">記憶體</td>
<td data-morhtml="true">可用系統記憶體總計的 %/PageFileBytes。<br data-morhtml="true" /><br data-morhtml="true" />可用的 PageFileBytes 總計大約是系統 RAM 的兩倍。</td>
        <td data-morhtml="true">60%</td>
        <td data-morhtml="true">70%</td>
    </tr>
    <tr data-morhtml="true">
<td data-morhtml="true">訊息處理</td>
<td data-morhtml="true">同時處理的訊息數目</td>
<td data-morhtml="true">40 * 核心數目</td>
<td data-morhtml="true">100 * 核心數目</td>
    </tr>
</table>
...
-   依每一角色執行個體來節流。例如：
    RoleInstanceA 節流。RoleInstanceB 未節流。在此情況下，RoleInstanceB 中的訊息如預期般地處理。RoleInstanceA 中的訊息會捨棄且失敗，並傳回下列錯誤：
    伺服器忙碌中。請再試一次。
-   所有提取來源不會輪詢或下載訊息。例如：
