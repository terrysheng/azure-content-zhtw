...
在 [Azure 管理入口網站預覽](http://go.microsoft.com/fwlink/?LinkId=398536)中，按一下 [**新增**]，然後選取 [**Redis 快取**]。 

  ![][1]

輸入 DNS 主機名稱。其格式為 `<name>.redis.cache.windows.net`。按一下 [**建立**]。
