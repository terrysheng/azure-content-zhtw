...
- 對於雲端服務角色啟用 Azure 診斷。 <br />< b / >如需詳細資訊，請參閱[在 Azure 雲端服務和虛擬機器中啟用診斷](cloud-services-dotnet-diagnostics.md)。
...
1. 對於將用來儲存詳細資訊監視資料的儲存體帳戶，複製儲存體存取金鑰。在 [Azure 管理入口網站](https://manage.windowsazure.com/)中，您可以使用 [**儲存體帳戶**] 頁面上的 [**管理金鑰**]。如需詳細資訊，請參閱[如何管理雲端服務](cloud-services-how-to-manage.md) (英文)，或參閱**儲存體帳戶**頁面的說明。 
