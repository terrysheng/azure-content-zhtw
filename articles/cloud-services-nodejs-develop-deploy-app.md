...
3.  輸入下列 Cmdlet 建立新的解決方案：
    ...
    ![New-AzureService helloworld 命令的結果][]
    ...
    **New-AzureServiceProject** Cmdlet 建立的檔案是：
    ...
    如需這些檔案的詳細資訊，請參閱[建立 Azure 託管服務的概觀][]。
...
5.  使用下列命令瀏覽到 **WebRole1** 目錄，然後在記事本中開啟 **server.js** 檔案。
    ...
    **server.js** 檔案是由 **Add-AzureNodeWebRole** Cmdlet 建立的，其中包含下列啟動程式碼。這段程式碼類似於 [nodejs.org][] 網站的「Hello World」範例，不過：
