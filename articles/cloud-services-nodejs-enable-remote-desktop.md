...
-   [步驟 1：使用 Azure PowerShell 設定服務的遠端桌面存取][步驟 1：使用 Azure PowerShell 設定服務的遠端桌面存取]
-   [步驟 2：連接到角色執行個體][步驟 2：連接到角色執行個體]
-   [步驟 3：使用 Azure PowerShell 將服務設定成停用遠端桌面存取][步驟 3：使用 Azure PowerShell 將服務設定成停用遠端桌面存取]
...
1.  在 [Azure 管理入口網站][Azure 管理入口網站]中選取 [雲端服務]，然後選取先前在步驟 1 中部署的服務
...
-   [從遠端存取 Azure 中的角色執行個體][從遠端存取 Azure 中的角色執行個體]
-   [搭配使用遠端桌面與 Azure 角色][搭配使用遠端桌面與 Azure 角色]
