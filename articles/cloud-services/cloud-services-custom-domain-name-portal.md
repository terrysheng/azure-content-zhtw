...
> [AZURE.NOTE]
> 此工作的程序適用於 Azure 雲端服務。如果是網站，請參閱「[設定 Azure App Service Web App 的自訂網域名稱](../app-service-web/web-sites-custom-domain-name.md)」(英文)。關於儲存體帳戶，請參閱＜[設定 Azure 儲存體帳戶的自訂網域名稱](../storage/storage-custom-domain-name.md)＞。
