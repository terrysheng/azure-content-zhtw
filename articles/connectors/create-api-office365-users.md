...
5. 完成時，會開啟新的 AAD 應用程式。選取 [**設定**]：![Contoso AAD 應用程式][10]

6. 在 [OAuth 2] 區段下，請將 [回覆 URL] 設定為當您在 Azure 入口網站中新增 Office 365 使用者 API 時顯示的重新導向 URL 值。選取 [**新增應用程式**]：![設定 Contoso AAD 應用程式][11]
