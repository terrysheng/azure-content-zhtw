<properties
pageTitle="在您的邏輯應用程式或 Power Apps 中使用 SharePoint Online API | Microsoft Azure"
description="開始在邏輯應用程式及 PowerApps 中使用Azure App Service SharePoint Online API。"
services=""	
documentationCenter="" 	
authors="msftman"	
manager="erikre"	
...
3. 選取 [線上登入 SharePoint]：![設定 SharePoint][2]    
...
6. 您可以新增完成邏輯應用程式所需的其他觸發和動作。   
7. 選取上方功能表列的 [儲存]，即可儲存您的工作。  

>[AZURE.TIP] 您可以在其他的邏輯應用程式或 PowerApps 中，或同時在這兩種應用程式中使用這個連線。
