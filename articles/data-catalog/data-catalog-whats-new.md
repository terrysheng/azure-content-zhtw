...
自 2015 年 10 月 16 日當週起，**Azure Data Catalog** 已加入下列功能：
...
自 2015 年 10 月 2 日當週起，**Azure Data Catalog** 已加入下列功能：

- 支援手動註冊已知的資料來源類型。對於 **Azure Data Catalog** 所支援的所有資料來源類型，使用者可以使用 **Azure Data Catalog** 入口網站手動輸入資料來源資訊。
- 支援授權 Azure Active Directory 安全性群組。目錄系統管理員可以讓您存取安全性群組與以及使用者帳戶的目錄，使得您易於管理 **Azure Data Catalog** 的存取。
...
自 2015 年 9 月 25 日當週起，**Azure Data Catalog** 已加入下列功能：
...
自 2015 年 9 月 18 日當週起，**Azure Data Catalog** 已加入下列功能：
...
自 2015 年 9 月 11 日當週起，**Azure Data Catalog** 已加入下列功能：
...
自 2015 年 9 月 4 日當週起，**Azure Data Catalog** 已加入下列功能：
...
> [AZURE.NOTE]針對 9 月 4 日前註冊的 SQL Server 資料表和檢視，必須在資料庫項目加入目錄之前，使用資料來源註冊工具重新加以註冊。重新註冊資料來源並不會影響使用者在 **Azure Data Catalog** 入口網站所加入的任何註解。

## 2015 年 8 月 28 日當週發行的新功能

自 2015 年 8 月 28 日當週起，**Azure Data Catalog** 已加入下列功能：
...
自 2015 年 8 月 21 日當週起，**Azure Data Catalog** 已加入下列功能：
