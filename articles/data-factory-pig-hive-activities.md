<properties title="Use Pig and Hive with Azure Data Factory" pageTitle="使用 Pig 和 Hive 搭配 Azure Data Factory" description="Learn how to process data by running Pig and Hive scripts on an Azure HDInsight cluster from an Azure data factory." metaKeywords=""  services="data-factory" solutions=""  documentationCenter="" authors="spelluru" manager="jhubbard" editor="monicar" />
