<properties 
	pageTitle="Azure SQL 資料倉儲連接器 - 從 Azure SQL 資料倉儲來回移動資料" 
	description="了解 Data Factory 服務的 Azure SQL 資料倉儲連接器，其可讓您從 Azure SQL 資料倉儲來回移動資料" 
...
# Azure SQL 資料倉儲連接器 - 從 Azure SQL 資料倉儲來回移動資料 
...
1. AzureSqlDW 類型的連結服務。
2. AzureStorage 類型的連結服務。 
3. AzureSqlDWTable 類型的輸入資料集。 
4. AzureBlob 類型的輸出資料集。
4. 具有使用 SqlDWSource 和 BlobSink 之複製活動的管線。
...
1.	AzureSqlDWDatabase 類型的連結服務。
2.	AzureStorage 類型的連結服務。
3.	AzureBlob 類型的輸入資料集。
4.	AzureSqlDWTable 類型的輸出資料集。
4.	具有使用 BlobSource 和 SqlDWSink 之複製活動的管線。
