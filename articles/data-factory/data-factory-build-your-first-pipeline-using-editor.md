...
2.	在 [新增 Data Factory] 刀鋒視窗中，輸入 **DataFactoryMyFirstPipeline** 做為 [名稱]。
	...
	> [AZURE.IMPORTANT]Azure Data Factory 的名稱在全域必須是唯一的。如果您收到錯誤：**Data Factory 名稱 “DataFactoryMyFirstPipeline” 無法使用**，請變更 Data Factory 名稱 (例如 yournameDataFactoryMyFirstPipeline)，然後試著重新建立。請參閱 [Data Factory - 命名規則](data-factory-naming-rules.md)主題，以了解 Data Factory 成品的命名規則。
	>  
