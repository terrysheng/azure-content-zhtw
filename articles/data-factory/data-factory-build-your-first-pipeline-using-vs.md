...
您必須在電腦上安裝下列項目：
- Visual Studio 2013
- 下載 Azure SDK for Visual Studio 2013。瀏覽至 [Azure 下載頁面](http://azure.microsoft.com/downloads/) 並按一下 [**.NET**] 區段中的 [VS 2013 安裝]。
...
2. 瀏覽至 [C:\\ADFGettingStarted]，然後選取 [partitionweblogs.hql] 檔案，並按一下 [新增]。 
