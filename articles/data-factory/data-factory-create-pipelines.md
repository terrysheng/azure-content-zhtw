...
1.	管線 P1 具有需要外部輸入資料集 D1 的活動 A1，並產生輸出資料集 D2。
2.	管線 P2 具有需要資料集 D2 的輸入的活動 A2，並產生輸出資料集 D3。
