...
## 管理和監視  
一旦部署管線，您即可管理和監視管線、配量和執行。如需詳細資訊，請參閱[監視和管理管線](data-factory-monior-manage-pipelines.md)。
