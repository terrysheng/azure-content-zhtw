<properties urlDisplayName="Learn Azure SQL Database and SQL Server in Azure VMs" pageTitle="了解 Azure SQL Database 和 Azure VM 中的 SQL Server" metaKeywords="SQL, Azure SQL Database, SQL Server IAAS, SQL Server in Azure VM" description="Learn Azure SQL Database and SQL Server in Azure Virtual Machines. Review common business motivators for determining which SQL technology works best for your application." metaCanonical="" services="virtual-machines" documentationCenter="" title="Understanding Azure SQL Database and SQL Server in Azure VMs" authors="selcint" solutions="data-management" manager="jeffreyg" editor="tysonn" />
...
在下列章節中，我們將了解最後兩個基本選項：Azure SQL Database 和 Azure VM 中的 SQL Server。此外，我們將探討常見的商業動因，以判斷哪一個選項最符合應用程式需求。
