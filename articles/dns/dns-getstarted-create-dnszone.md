...
Azure DNS 使用 Azure 資源管理員 (ARM)。針對 Azure PowerShell 1.0.0 與上述項目依照此指示執行。如需詳細資訊，請參閱[將 Windows PowerShell 與資源管理員搭配使用](powershell-azure-resource-manager.md)。<BR><BR>
