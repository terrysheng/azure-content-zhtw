...
1. 在 Visual Studio 的 \[**檔案**\] 功能表中，指向 \[**新增**\]，然後按一下 \[**專案**\]。
   ...
   \[**新增專案** \] 對話方塊隨即出現。2.在 \[**專案類型**\] 窗格中，依序展開 \[**範本**\]、\[**Visual C\#**\]、\[**Web**\]，然後選取 \[**ASP.NET Web 應用程式**\]。
...
4. 在 \[[Azure 入口網站](https://portal.azure.com/)\] 中，擷取 DocumentDB 帳戶中 \[**金鑰**\] 刀鋒視窗中的 \[**URI**\] 和 \[**主要金鑰**\] 或 \[**次要金鑰**\] 值。
	...
	![顯示 DocumentDB 帳戶的 Azure 入口網站螢幕擷取畫面，內含反白顯示的 \[主動式\] 集線器、 \[DocumentDB 帳戶\] 刀鋒視窗上反白顯示的 \[金鑰\] 按鈕、\[金鑰\] 刀鋒視窗上反白顯示的 \[URI\]、\[主要金鑰\] 和 \[次要金鑰\] 值](../includes/media/documentdb-keys/keys.png)
