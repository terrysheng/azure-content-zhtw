...
> [AZURE.TIP] DocumentDB 中的文件有大小上限。如需詳細資訊，請參閱 [DocumentDB 限制](../documentdb-limits)。
...
若要了解在 Azure DocumentDB 中微調索引，請參閱[索引原則](../documentdb-indexing-policies)上的文章。

若要了解如何跨多個分割將您的資料分區，請參閱[在 DocumentDB 中分割資料](../documentdb-partition-data)。 
