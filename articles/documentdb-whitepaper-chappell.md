...
**摘要：**了解 DocumentDB 是 Microsoft Azure 上受管理的 NoSQL 資料庫。在下列情況下，DocumentDB 是理想的資料庫技術選擇：
...
**下載：** [DocumentDB 簡介 - 適用於 Microsoft Azure 的 NoSQL Database](http://go.microsoft.com/fwlink/?LinkId=511318)
