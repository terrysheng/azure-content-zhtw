...
2.  在 [DocumentDB 帳戶] 刀鋒視窗中，選取要在其中加入集合的帳戶。如果您沒有任何列出的帳戶，您需要[建立 DocumentDB 帳戶](documentdb-create-account.md)。

3. 在所選取帳戶的 [DocumentDB 帳戶] 刀鋒視窗中，向下捲動至 [資料庫] 透鏡，然後選取要在其中加入集合的資料庫。
