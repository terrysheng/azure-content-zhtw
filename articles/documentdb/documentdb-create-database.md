...
2.  在 [**DocumentDB 帳戶**] 刀鋒視窗中，選取要在其中新增 DocumentDB 資料庫的帳戶。如果您沒有任何列出的帳戶，您需要[建立 DocumentDB 帳戶](documentdb-create-account.md)。
