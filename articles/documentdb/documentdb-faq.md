...
是，DocumentDB 符合 HIPAA 標準。HIPAA 建立了使用、洩漏與保護個別辨識健全狀況資訊的需求。如需詳細資訊，請參閱 [Microsoft Trust Center (Microsoft 信任中心)](https://www.microsoft.com/en-us/TrustCenter/Compliance/HIPAA)。
