<properties 
	pageTitle="資料庫移轉工具 - 將 CSV 轉換成 JSON |Microsoft Azure" 
	description="了解如何使用開放原始碼 DocumentDB 資料移轉工具將資料匯入 DocumentDB。MongoDB、SQL、表格儲存體、DynamoDB 和 CSV 轉換成 JSON。" 
