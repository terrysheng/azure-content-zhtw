...
您可以透過 Azure 傳統入口網站 ([http://portal.azure.com/](http://portal.azure.com/)) [建立和管理 DocumentDB 資料庫帳戶](documentdb-create-account.md)。建立和管理資料庫帳戶都需要管理存取權，而且只有在 Azure 訂用帳戶下才能執行。
