...
### <a name="1.5.1"/>[1\.5.1](https://www.nuget.org/packages/Microsoft.Azure.DocumentDB/1.5.1)
 - **[修正]** 如果 Select 不是最後一個運算式，LINQ 提供者會假設沒有預測，並產生不正確的 SELECT *。[#58](https://github.com/Azure/azure-documentdb-dotnet/issues/58)
...
### <a name="1.5.0"/>[1\.5.0](https://www.nuget.org/packages/Microsoft.Azure.DocumentDB/1.5.0)
 ...
 - **[已過時]** UriFactory.CreateCollection --> 現在應該使用 UriFactory.CreateDocumentCollection
...
### <a name="1.3.0"/>[1\.3.0](https://www.nuget.org/packages/Microsoft.Azure.DocumentDB/1.3.0)
  ...
  - **[已修正]**：從 linq 運算式產生不正確的 SQL 查詢 [#38](https://github.com/Azure/azure-documentdb-net/issues/38)
