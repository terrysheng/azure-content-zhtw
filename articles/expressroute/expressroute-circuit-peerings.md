...
||**私用對等**|**公用對等**|**Microsoft 對等**|
|---|---|---|---|
|**每種對等支援的首碼數目上限**|預設值為 4000，在 ExpressRoute Premium 中為 10,000 |200|200|
...
|**路由介面 IP 位址**|RFC1918 和公用 IP 位址|路由註冊中註冊給客戶的公用 IP 位址。| 路由註冊中註冊給客戶的公用 IP 位址。|
|**MD5 雜湊支援**| 是|是|是|
