...
使用者可能在 Azure PowerShell 或 Azure 入口網站中遇到的錯誤會以名稱的字母順序列在 [[HDInsight 名稱]](#hdinsight-error-messages) 區段中，在此處連結到[錯誤的描述和緩和](#discription-mitigation-errors) 區段中的項目，提供錯誤的下列資訊：
