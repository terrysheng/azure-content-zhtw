...
* **New-AzureHDInsightMapReduceJobDefinition** - 使用指定的 MapReduce 資訊，建立新的 *job definition*
...
2. 開啟新的 **Microsoft Azure PowerShell** 提示字元。將目錄變更至 **mapreducejob.ps1** 檔案的位置，然後使用下列命令來執行指令碼。
