<properties title="使用 HDInsight 上的 Hive 分析感應器資料" pageTitle="使用 Hive 和 Microsoft Azure HDInsight (Hadoop) 分析感應器資料" description="了解如何在 HDInsight (Hadoop) 上使用 Hive 和 Excel 來分析和視覺化感應器資料" metaKeywords="Azure hdinsight hive, Azure hdinsight hive sensor, azure hadoop hive, azure hadoop sensor, azure hadoop excel, azure hdinsight excel" services="hdinsight" solutions="" documentationCenter="big-data" authors="larryfr" videoId="" scriptId="" />

<tags ms.service="hdinsight" ms.workload="big-data" ms.tgt_pltfrm="na" ms.devlang="na" ms.topic="article" ms.date="09/30/2014" ms.author="larryfr" />

# 使用 HDInsight 上的 Hive 分析感應器資料
...
-   HDInsight (Hadoop) 叢集 - 如需有關建立叢集的相關資訊，請參閱＜[在 HDInsight 中佈建 Hadoop 叢集][在 HDInsight 中佈建 Hadoop 叢集]＞

-   Microsoft Excel 2013

    > [WACOM.NOTE] Microsoft Excel 可透過 [Power View][Power View] (目前只有 Windows 版) 將資料視覺化。

-   [Microsoft Hive ODBC 驅動程式][Microsoft Hive ODBC 驅動程式]
