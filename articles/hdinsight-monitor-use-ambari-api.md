...
HDInsight 目前僅支援 Ambari 監視功能。HDInsight 叢集 2.1 和 3.0 版可支援 Ambari API 1.0 版。本文涵蓋在 HDInsight 叢集 3.1 和 2.1 版上存取 Ambari API。  兩者的主要差別在於某些元件已隨著新功能引進而變更 (例如工作歷程伺服器)。
