...
本主題說明如何使用 Azure Powershell 在 Azure HDinsight 上執行簡單的 MapReduce 程式，以估計數學常數 Pi 的值。
...
＜[執行 HDInsight 範例](/en-us/manage/services/hdinsight/howto-run-samples)＞列出其他範例來協助您更快使用 HDInsight 來執行 MapReduce 工作，也提供執行指示的連結。
