...
-   HDInsight 叢集。如需有關透過其他各種方法建立此類叢集的指示，請參閱[佈建 HDInsight 叢集](/en-us/manage/services/hdinsight/provision-hdinsight-clusters/)。

-   已安裝並設定 Azure PowerShell 的工作站。相關指示請參閱[安裝和設定 Azure PowerShell](/en-us/manage/install-and-configure-windows-powershell/)。
...
-   MapReduce 程式。在本教學課程中，您將使用 HDInsight 叢集所提供的字數統計範例，因此您不需要自行撰寫。它位在 */example/jars/hadoop-examples.jar*。在 3.0 版 HDInsight 叢集上，該檔案名稱為 *hadoop-mapreduce-examples.jar*。如需自行撰寫 MapReduce 工作的指示，請參閱[開發 HDInsight 的 Java MapReduce 程式](/en-us/documentation/articles/hdinsight-develop-deploy-java-mapreduce/)。
...
1.  開啟 **Azure PowerShell**。如需有關開啟 Azure PowerShell 主控台視窗的指示，請參閱[安裝和設定 Azure PowerShell](/en-us/manage/install-and-configure-windows-powershell/)。
...
用來統計字數的 MapReduce 程式的 Java 程式碼
-------------------------------------------
...
-   [在 HDInsight 上使用 Hive](/en-us/documentation/articles/hdinsight-use-hive/)
-   [在 HDInsight 上使用 Pig](/en-us/documentation/articles/hdinsight-use-pig/)
-   [執行 HDInsight 範例](/en-us/documentation/articles/hdinsight-run-samples/)
