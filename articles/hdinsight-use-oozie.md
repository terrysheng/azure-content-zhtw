...
了解如何定義工作流程，以及如何在 HDInsight 上執行工作流程。若要了解 Oozie 協調器，請參閱[將以時間為基礎的 Oozie 協調器用於 HDInsight][]。
...
*C:\\apps\\dist\\oozie-3.3.2.1.3.2.0-05\\oozie-win-distro\\logs\\Oozie.log* 或 *C:\\apps\\dist\\oozie-4.0.0.2.0.7.0-1528\\oozie-win-distro\\logs\\Oozie.log* 中的 Oozie 記錄檔。如需 RDP 的相關資訊，請參閱[使用管理入口網站管理 HDInsight 叢集][]。
