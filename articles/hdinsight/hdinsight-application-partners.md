<properties pageTitle="HDInsight 應用程式合作夥伴 | Microsoft Azure" description="客戶現在可以從佈建入口網站輕易地探索和部署巨量資料應用程式及其 HDInsight 叢集。" services="hdinsight" documentationCenter="na" authors="pablissima" manager="paulettm="" tags=""/>
<tags 
