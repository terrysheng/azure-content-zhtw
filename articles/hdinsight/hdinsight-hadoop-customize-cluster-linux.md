...
自訂元件則獲得商務上合理的支援，協助您進一步疑難排解問題。如此可能會進而解決問題或要求您參與可在其中找到開放原始碼技術深度專業知識的可用管道。例如，有許多社群網站可以使用，像是：

* [HDInsight 的 MSDN 論壇](https://social.msdn.microsoft.com/Forums/azure/home?forum=hdinsight)

* [堆疊溢位](https://stackoverflow.com)

另外，Apache 專案在 [Apache.org](https://apache.org) 上有專案網站；例如，[Hadoop](http://hadoop.apache.org/) 和 [Spark](http://spark.apache.org/)。
