...
- 建立 HDInsight 叢集
	...
	###########################################
	# 建立叢集
	########################################### $httpCredential =Get-Credential -Message "請輸入 HTTP 帳戶認證：" New-AzureRmHDInsightCluster `
