...
# 教學課程：設定內部部署 VMM 網站和 Azure 之間的保護
...
<h2><a id="prerequisites" name="prerequisites" href="#prerequisites"></a>必要條件</h2>
...
<LI><a href="#download">步驟 2：在 VMM 伺服器上安裝提供者應用程式</a>-在保存庫中產生註冊金鑰並下載提供者安裝檔。您將在 VMM 伺服器上執行安裝程式來安裝提供者，並在保存庫中註冊伺服器。</LI>
<LI><a href="#storage">步驟 3：新增 Azure 儲存體帳戶</a>-如果您沒有帳戶，請建立一個帳戶。 </LI>
<LI><a href="#agent">步驟 4：安裝代理程式應用程式</a>-在您想要保護之 VMM 雲端中的每一部 Hyper-V 主機上，安裝 Microsoft Azure 復原服務代理程式。</LI>
...
<LI><a href="#virtualmachines">步驟 7：為虛擬機器啟用保護</a>-對受保護 VMM 雲端中的虛擬機器啟用保護。</LI>
<LI><a href="#test">步驟 8：測試部署</a>-您可以執行測試容錯移轉的單一虛擬機器，或您可以建立復原計畫和執行測試容錯移轉計畫來確定其運作正常。</LI>
</UL>
...
<h3><a id="agent"></a>步驟 4：在 Hyper-V 主機上安裝 Azure 復原服務代理程式</h3>
...
<h3><a id="networkmapping"></a>步驟 6：設定網路對應</h3>

<p>本教學課程說明在測試環境中部署 Azure Site Recovery 的最簡單路徑。如果您不想在進行本教學課程時設定網路對應，請閱讀《規劃指南》中的<a href="http://go.microsoft.com/fwlink/?LinkId=324817">準備網路對應</a>。若要設定對應，請遵循《部署指南》之<a href="http://go.microsoft.com/fwlink/?LinkId=402533">設定網路對應</a>中的步驟進行。</p>




<h3><a id="virtualmachines"></a>步驟 7：為虛擬機器啟用保護</h3>
