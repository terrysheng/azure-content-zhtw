<properties title="How to debug with events" pageTitle="如何使用事件偵錯" description="Learn how to see events in Azure." authors="hanikn" manager="kamrani" />
...
6. 現在，按一下 [**上週事件**] 組件。您會看見名為 [**事件**] 的新分頁，其中包含上週所有對您的資源群組造成影響的事件。
