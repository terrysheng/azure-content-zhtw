...
本教學課程以[使用 IoT 中心傳送雲端到裝置訊息]中的程式碼建置，以示範如何使用雲端到裝置訊息來安全地提供用來上傳檔案之 Azure Blob URI 給裝置，以及如何使用 IoT 中心傳遞通知來觸發來自您應用程式後端的檔案處理。此方法的優點是重複使用 IoT 中心裝置身分識別以及雲端到裝置訊息的傳遞通知，來通知應用程式後端檔案已經順利上載。
