...
Microsoft Azure IoT 套件是企業級解決方案，可讓您快速開始使用一組可延伸的預先設定解決方案，該方案可解決常見的 IoT 案，例如遠端監視和連線的裝置。
...
您也可能對預先設定之解決方案使用的許多 [Azure IoT 中樞][]服務感興趣。[Azure IoT 中樞][]提供許多範例解決方案架構中定義的「資料處理和分析」功能。
