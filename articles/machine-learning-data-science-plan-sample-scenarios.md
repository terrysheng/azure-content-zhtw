<properties
	pageTitle="雲端資料科學程序逐步解說 | Azure" 
	description="雲端資料科學程序逐步解說" 
	metaKeywords="" 
...
# Azure 機器學習中的雲端資料科學程序

本文將逐步解說雲端資料科學程序地圖及部分範例資料來源和目標案例。它將說明部分選項和根據資料字元、來源位置和 Azure 中目標儲存機制的處理順序。前一節中已摘要說明範例案例的雲端資料科學處理流程。
