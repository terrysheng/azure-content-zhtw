<properties 
	pageTitle="使用 Machine Learning Python 用戶端程式庫從 Python 存取資料集 | Azure" 
...
1. 向擁有者要求權杖。擁有者能夠在 Studio 中，從他們工作區的 [設定] 頁面存取其授權權杖。選擇左窗格中的 [設定]****，然後按一下 [授權權杖]****，即可看到主要與次要權杖。![](http://i.imgur.com/h33GoZX.jpg) 雖然主要或次要授權權杖都能用於程式碼片段，但建議擁有者只共用次要授權權杖。
