<properties
	pageTitle="預測性維護的 Cortana Analytics 解決方案範本腳本 | Microsoft Azure"
	description="包含適用於預測性維護的 Microsoft Cortana Analytics 的解決方案範本。"
...
# 預測性維護的 Cortana Analytics 解決方案範本腳本
...
>[AZURE.TIP]若要下載可提供此範本架構概觀的圖表，請參閱[預測性維護的 Cortana Analytics 解決方案範本架構](cortana-analytics-architecture-predictive-maintenance.md)。
