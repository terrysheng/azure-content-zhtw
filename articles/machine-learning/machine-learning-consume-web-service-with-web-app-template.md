...
3. 移至 [Azure ML 要求回應服務 Web 應用程式](https://azure.microsoft.com/marketplace/partners/microsoft/azuremlaspnettemplateforrrs/)並且按一下 [建立 Web 應用程式]。範本會帶您前往 Microsoft Azure 傳統入口網站，在其中建立新的 Web 應用程式。
