...
是的，您可以在 ML Studio 中放入現有的 R 程式碼，並使用 Azure 機器學習提供的學習器在相同的實驗中加以執行，然後透過 Azure 機器學習部署為 Web 服務。請參閱[透過 R 擴展您的實驗](machine-learning-extend-your-experiment-with-r.md)。
