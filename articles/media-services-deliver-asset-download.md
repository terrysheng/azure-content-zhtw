...
本文是介紹 Azure 媒體服務程式設計的系列文章之一。上一個主題是[作法：管理資產](http://go.microsoft.com/fwlink/?LinkID=301815&clcid=0x409)。
...
此主題說明了從 Azure 儲存體下載資產的方式。如需其他資產傳遞方式的相關資訊，請移至[如何傳遞串流內容](http://go.microsoft.com/fwlink/?LinkID=301942)主題。
