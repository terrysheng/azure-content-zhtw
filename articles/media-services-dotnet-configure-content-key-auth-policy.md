...
如果您想要媒體服務加密資產，則需要將加密金鑰 (**CommonEncryption** 或 **EnvelopeEncryption**) 與資產產生關聯 (如[這裡](media-services-dotnet-create-contentkey.md)所述)，同時設定金鑰的授權原則 (如本文所述)。 
...
若要取得根據用於金鑰授權原則之權杖限制的測試權杖，請參閱[本](#test)一節。 
