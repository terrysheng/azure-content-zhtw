...
![靜態編碼](./media/media-services-dynamic-packaging/media-services-static-packaging.png)

下圖顯示動態封裝工作流程。

![動態編碼](./media/media-services-dynamic-packaging/media-services-dynamic-packaging.png)
