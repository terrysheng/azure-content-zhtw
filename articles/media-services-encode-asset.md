<properties urlDisplayName="How to Encode an Asset" pageTitle="如何為媒體服務的資產編碼 - Azure" metaKeywords="" description="Learn how to use the Azure Media Encoder to encode media content on Media Services. Code samples are written in C# and use the Media Services SDK for .NET." metaCanonical="" services="media-services" documentationCenter="" title="How to: Encode an Asset" authors="juliako" solutions="" manager="dwrede" editor="" />

<tags ms.service="media-services" ms.workload="media" ms.tgt_pltfrm="na" ms.devlang="na" ms.topic="article" ms.date="10/30/2014" ms.author="juliako" />


#作法：為資產編碼
本文是介紹 Azure 媒體服務程式設計的系列文章之一。上一個主題是[作法：取得媒體處理器] (英文)(../media-services-get-media-processor/)。
...
##後續步驟
您已了解如何建立為資產編碼的工作，現在請移至[如何使用媒體服務檢查工作進度] (英文)(../media-services-check-job-progress/) 主題。

[Azure Marketplace]: https://datamarket.azure.com/
[編碼器預設]: http://msdn.microsoft.com/zh-tw/library/dn619392.aspx
[作法：取得媒體處理器執行個體]：http://go.microsoft.com/fwlink/?LinkId=301732
[作法：上傳加密的資產]：http://go.microsoft.com/fwlink/?LinkId=301733
[作法：透過下載來傳遞資產] (英文)：http://go.microsoft.com/fwlink/?LinkId=301734
