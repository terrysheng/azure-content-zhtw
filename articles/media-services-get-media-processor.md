...
本文是介紹 Azure 媒體服務程式設計的系列文章之一。上一個主題是＜[作法：建立加密資產並上傳至儲存體][]＞。
...
現在您已了解如何取得媒體處理器執行個體，接著請移至[如何為資產編碼][]主題，以了解如何使用 Azure Media Encoder 為資產編碼。
  ...
  [作法：建立加密資產並上傳至儲存體]: http://go.microsoft.com/fwlink/?LinkID=301733&clcid=0x409
  [Azure Media Encoder 的工作預設字串]: http://msdn.microsoft.com/en-us/library/jj129582.aspx
  [Azure Media Packager 的工作預設字串]: http://msdn.microsoft.com/en-us/library/hh973635.aspx
  [1]: http://msdn.microsoft.com/en-us/library/hh973610.aspx
  [作法：以程式設計方式連接到媒體服務]: http://www.windowsazure.com/en-us/develop/media-services/how-to-guides/set-up-computer-for-media-services
  [如何為資產編碼]: http://go.microsoft.com/fwlink/?LinkId=301753
