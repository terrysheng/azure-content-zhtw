...
如需詳細資訊，請參閱[搭配使用協力廠商即時編碼器與 Azure 媒體服務 ](https://msdn.microsoft.com/zh-tw/library/azure/dn783464.aspx)。

## 管理通道、程式、資產

如需詳細資訊，請參閱[即時資料流](https://msdn.microsoft.com/zh-tw/library/azure/dn783466.aspx)。
...
如需調整串流單位的相關資訊，請參閱：[如何調整串流單位](../media-services-manage-origins#scale_streaming_endpoints)。
