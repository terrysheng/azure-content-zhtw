<properties urlDisplayName="How to monitor" pageTitle="監視媒體服務帳戶 - Azure" metaKeywords="" description="說明如何為 Azure 中的媒體服務帳戶設定監視功能。" metaCanonical="" services="media-services" documentationCenter="" title="如何監視媒體服務帳戶" authors="juliako" solutions="" manager="dwrede" editor="" />

<tags ms.service="media-services" ms.workload="media" ms.tgt_pltfrm="na" ms.devlang="na" ms.topic="article" ms.date="01/01/1900" ms.author="juliako" />

# <span id="monitormediaservicesaccount"></span></a>如何監視媒體服務帳戶
...
> [WACOM.NOTE] 其他成本與 Azure 管理入口網站中監視儲存體資料有關。如需詳細資訊，請參閱[儲存體分析及計費][儲存體分析及計費]。

## <span id="configuremonitoring"></span></a>作法：監視媒體服務帳戶

1.  在[管理入口網站][管理入口網站]中，按一下 [媒體服務]，然後按一下媒體服務帳戶名稱來開啟儀表板。
...
## <span id="configuringstorage"></span></a>作法：監視 Blob 儲存體使用量 (選用)
...
1.  完成監視組態時，按一下 [儲存]。
    ...
    度量存放在儲存體帳戶中的四個資料表：$MetricsTransactionsBlob、$MetricsTransactionsTable、$MetricsTransactionsQueue 及 $MetricsCapacityBlob。如需詳細資訊，請參閱＜[儲存體分析度量][儲存體分析度量]＞。

<!-- Images -->

  [儲存體分析及計費]: http://go.microsoft.com/fwlink/?LinkId=256667
  [管理入口網站]: http://go.microsoft.com/fwlink/?LinkID=256666
  ...
  [儲存體分析度量]: http://go.microsoft.com/fwlink/?LinkId=256668
