...
**Media Encoder Premium Workflow** 支援[本](#closed_captioning) 節所述的隱藏式字幕。 
...
- JPEG2000
- MPEG-2 (高達 422 Profile 和 High Level，包括 XDCAM、XDCAM HD、XDCAM IMX、CableLabs (r) 和 D10 等變種)
- MPEG-1
...
- AES (SMPTE 331M 和 302M，AES3-2003)
- Dolby(r) Digital (AC3)
- Dolby(r) Digital Plus (E-AC3) 高達 7.1
- AAC (AAC-LC、AAC-HE 和 AAC-HEv2；高達 5.1)
- MPEG Layer 2
- MP3 (MPEG-1 音訊層 3)
- Windows Media 音訊
...
**Media Encoder Premium Workkflow** 媒體處理器目前在交錯至來源或輸入媒體檔案時支援隱藏式字幕：CEA 608/CEA 708 本質上執行為使用者資料 (H.264 基礎資料流的 SEI 訊息、ATSC/53、SCTE20) 或執行為 MXF/GXF 檔案中的輔助資料。

輸出時，下列選項可用於重新封裝輸入中的 CEA 608/708：

- CEA-608 至 CEA-708 翻譯
- CEA-608/CEA-708 傳遞 (內嵌在 H.264 基礎資料流的 SEI 訊息，或執行為 MXF 檔案中的輔助資料)
- SCC
- SMPTE 計時文字 (來自來源 CEA-608 經由 SMPTE RP2052，包括建立 DFXP 檔案)
- SRT 副標題檔案
- DVB 副標題資料流
