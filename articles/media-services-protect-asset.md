...
作法：使用 PlayReady 保護來保護資產
===================================

本文是介紹 Azure 媒體服務程式設計的系列文章之一。上一個主題是[作法：檢查工作進度](http://go.microsoft.com/fwlink/?LinkID=301737&clcid=0x409)。
...
您已了解如何使用媒體服務來保護資產， 現在可移至[如何管理資產](http://go.microsoft.com/fwlink/?LinkID=301943&clcid=0x409)主題。
