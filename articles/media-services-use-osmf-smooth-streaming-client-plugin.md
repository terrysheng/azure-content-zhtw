...
-   AdobeÂ® FlashÂ® Player 10.2 或更新版本。
-   此版本僅支援 OSMF 2.0。
...
6.  儲存您的 HTML 頁面，並發佈至 Web 伺服器。使用您慣用且具有 FlashÂ® Player 功能的網際網路瀏覽器 (Internet Explorer、Chrome、Firefox 等)，瀏覽至已發佈的網頁。
7.  在 AdobeÂ® FlashÂ® Player 內欣賞 Smooth Streaming 內容。
