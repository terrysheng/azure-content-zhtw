...
3. 按一下 [建立通道]。![FMLE](./media/media-services-fmle-live-encoder/media-services-fmle2.png)
...
>[AZURE.IMPORTANT]在您按一下 [連接] 之前，**必須**確保通道已就緒。此外，請務必不要讓通道在沒有輸入比重摘要的情況下，處於就緒狀態超過 15 分鐘。
