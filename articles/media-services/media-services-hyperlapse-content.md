<properties
	...
	description="Azure Media Hyperlapse 可以使用第一人稱視角或運動攝影機內容建立流暢的縮時攝影影片。本主題說明如何使用 Media Indexer。"
...
如需 Azure 媒體 Hyperlapse 的更新，請參閱[媒體服務部落格](http://azure.microsoft.com/blog/topics/media-services/)。
