<properties 
   ...
   description="Azure Mobile Engagement [瀏覽] 區段的使用者介面概觀" 
...
UI 前端入口網站位於： https://YourApp.portal.mobileengagementwindows.net/ 包含下列瀏覽項目：頁首、頁尾、提要欄位、Cookie 連結瀏覽和應用程式專屬功能區。
