<properties 
	...
	description="適用於 Azure Mobile Engagement 的 Windows Phone SDK 升級程序" 					
...
使用封存套件內，[lib] 資料夾中的 azuresdk-mobileengagement-windowsphone-VERSION.nupkg 取代 Capptain.WindowsPhone.nupkg。
...
針對其他資源，例如 Capptain 圖片，請注意它們也已重新命名使用 "Engagement"。
...
[nuget 網站]:http://www.nuget.org/packages/Capptain.WindowsPhone
