<properties pageTitle="在資料中加入分頁 (Android) | 行動開發人員中心" description="了解如何使用分頁來管理行動服務傳回您 Android 應用程式的資料量。" services="mobile-services" documentationCenter="android" authors="RickSaling" manager="dwrede" editor=""/>
