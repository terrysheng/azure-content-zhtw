...
>[AZURE.NOTE] 若要查看已完成應用程式的原始程式碼，請移至 <a href="https://github.com/RickSaling/mobile-services-samples/tree/futures/GettingStarted/Android" target="_blank">開始</a>。
...
5. 立即下載您的應用程式：
	- 最新的應用程式版本使用行動服務 Android SDK 2.0。You can download that version from <a href="https://github.com/RickSaling/mobile-services-samples/tree/futures">here</a>。按一下 [**下載 Zip**]，將它解壓縮，專案會出現在 Android 資料夾下的 GettingStarted 中。
	 
	- An earlier versio uses the prior version of the SDK.若要使用它，請在 [**下載及執行您的應用程式**] 下方，按一下 [**下載**]。這將會下載與行動服務連接的範例「_待辦事項清單_」應用程式專案。專案檔案已壓縮，請瀏覽到其位置，並將檔案解壓縮到您的電腦上。
...
3. 按一下 **[瀏覽]**，瀏覽至展開的專案檔案位置，按一下 **[確定]** 以確定已勾選 TodoActivity 專案，然後按一下 **[完成]**。 
...
4. 從 **[執行]** 功能表中按一下 **[執行]**，在 Android 模擬器中啟動專案。
