...
5. 立即下載您的應用程式：
	...
	- 較早的版本會使用先前版本的 SDK。若要使用它，請在 [**下載及執行您的應用程式**] 下方，按一下 [**下載**]。這將會下載與行動服務連接的範例_To do list_應用程式專案。專案檔案已壓縮，請瀏覽到其位置，並將檔案解壓縮到您的電腦上。
...
5. 在應用程式中，輸入有意義的文字，例如 _Complete the tutorial_，然後按一下 [**新增**]。
