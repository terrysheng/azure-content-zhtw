...
+ [將推播通知新增至行動服務應用程式](/zh-tw/documentation/articles/mobile-services-javascript-backend-android-get-started-push/)<br/>更新 TodoList 行動服務來使用 Azure 通知中樞，將通知傳送給 TodoList 範例應用程式的使用者。
+ [傳送推播通知給已驗證的使用者](/zh-tw/documentation/articles/mobile-services-javascript-backend-android-push-notifications-app-users/)<br/>延伸先前的教學課程，只允許已登入的使用者註冊通知。
