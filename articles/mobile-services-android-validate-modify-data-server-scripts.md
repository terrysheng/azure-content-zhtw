<properties 
	pageTitle="使用伺服器指令碼驗證與修改資料 (Android) | 行動開發人員中心" 
	description="了解如何驗證和修改從 Android 應用程式使用伺服器指令碼傳送的資料。" 
...
5. 在 [封裝總管] 中開啟 ToDoItemAdapter.java 檔案，然後新增下列 **import** 陳述式：

		import java.text.DateFormat;

6. 在 GetView 方法中新增下列程式碼：
