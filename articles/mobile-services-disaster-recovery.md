<properties urlDisplayName="Recover your mobile service in the event of a disaster" pageTitle="發生災害時回復行動服務 - Azure 行動服務" metaKeywords="" description="了解如何在發生災害時回復行動服務。" metaCanonical="" services="" documentationCenter="Mobile" title="Recover your mobile service in the event of a disaster" authors="brettsam" solutions="" manager="dwrede" editor="" />
