...
本教學課程會以行動服務快速入門為基礎。在開始本教學課程之前，您必須首先完成[開始使用行動服務][]。本教學課程需要 [Mobile Services iOS SDK][] 和 [XCode 4.5][] 及 iOS 5.0 或更新版本。
...
<!-- URLs. -->
  ...
  [.NET 後端]: /zh-tw/documentation/articles/mobile-services-dotnet-backend-ios-call-custom-api ".NET 後端"
  [JavaScript 後端]: /zh-tw/documentation/articles/mobile-services-ios-call-custom-api "JavaScript 後端"
