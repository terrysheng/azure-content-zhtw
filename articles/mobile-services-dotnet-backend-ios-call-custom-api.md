<properties pageTitle="從 iOS 應用程式呼叫自訂 API | 行動服務" description="了解如何定義自訂 API 然後從使用 Windows Azure 行動服務的 iOS 應用程式呼叫它。" services="mobile-services" documentationCenter="ios" authors="krisragh" writer="krisragh" manager="dwrede" editor=""/>
