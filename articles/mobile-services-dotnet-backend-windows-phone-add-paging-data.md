<properties pageTitle="在資料中加入分頁 (Windows Phone) | 行動開發人員中心" description="了解如何使用分頁來管理行動服務傳回您 Windows Phone 應用程式的資料量。" services="mobile-services" documentationCenter="windows" authors="ggailey777" manager="dwrede" editor=""/>
