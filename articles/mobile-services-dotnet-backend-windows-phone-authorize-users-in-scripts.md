<properties pageTitle="伺服器端授權 (Windows Phone) | 行動開發人員中心" description="了解如何在 Azure 行動服務的 .NET 後端為使用者授權。" services="" documentationCenter="windows" authors="ggailey777" manager="dwrede" editor=""/>
...
1. 在 Visual Studio 2013 for Windows Phone 中，開啟您在完成[開始使用驗證]教學課程時所修改的專案。
