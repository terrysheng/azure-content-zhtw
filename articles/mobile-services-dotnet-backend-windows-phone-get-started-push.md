...
> [WACOM.NOTE]此教學課程的目標是 Windows Phone 8.1 "Silverlight" 應用程式。如果您是要建立 Windows Phone 8.1 市集應用程式，則請參閱此教學課程的 [Windows 市集應用程式][]版本。如需 Windows Phone Silverlight 應用程式及其與 Windows Phone 市集應用程式比較的相關資訊，請參閱 [Windows Phone Silverlight 8.1 應用程式][]。
