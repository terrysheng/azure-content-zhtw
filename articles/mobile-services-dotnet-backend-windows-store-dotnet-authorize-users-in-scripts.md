<properties pageTitle="伺服器端授權 (Windows 市集) | 行動開發人員中心" description="了解如何在 Azure 行動服務的 .NET 後端為使用者授權。" services="" documentationCenter="windows" authors="ggailey777" manager="dwrede" editor=""/>
...
這將結束示範使用驗證基本概念的教學課程。請考慮更深入了解下列行動服務主題:
