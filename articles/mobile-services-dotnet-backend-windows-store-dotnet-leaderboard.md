...
本教學課程使用 [Visual Studio 2013 Update 3](http://go.microsoft.com/fwlink/p/?LinkID=390465)。 
...
在 Visual Studio 2013 Update 3 中，ASP.NET Web 應用程式專案包含 Windows Azure 行動服務的範本。請選取此範本，然後按一下 [**確定**]。
