<properties pageTitle="使用行動服務將影像上傳至 Blob 儲存體 (Windows 市集) | 行動服務" description="了解如何使用行動服務將影像上傳至 Azure Blob 儲存體。" documentationCenter="windows" authors="ggailey777" writer="glenga" services="mobile-services" manager="dwrede" editor=""/>
...
2. 在左側窗格中依序選取 [**線上**] 類別、[**包含發行前版本**]，搜尋 **WindowsAzure.Storage-Preview**，按一下 [**Azure 儲存體** 封裝上的 [**安裝**]，然後接受授權合約。 
