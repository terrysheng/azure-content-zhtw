...
2. 接著，在 MainPage.xaml.cs 檔案中，使用下列以新的 **CompleteDate** 屬性做為可為 Null 之類型的定義，取代現有的 **TodoItem** 類別。
