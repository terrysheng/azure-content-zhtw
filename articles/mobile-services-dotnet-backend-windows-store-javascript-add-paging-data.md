<properties pageTitle="在資料中加入分頁 (JavaScript) - Azure 行動服務" metaKeywords="" description="了解如何使用分頁來管理行動服務傳回您 Windows 市集 JavaScript 應用程式的資料量。" metaCanonical="" services="mobile-services" documentationCenter="Mobile" title="Refine Mobile Services queries with paging" authors="glenga" solutions="" manager="dwrede" editor="" />
