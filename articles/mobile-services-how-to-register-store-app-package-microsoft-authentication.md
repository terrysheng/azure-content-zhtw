...
在註冊應用程式封裝後，當您呼叫 <a href="http://go.microsoft.com/fwlink/p/?LinkId=311594" target="_blank">LoginAsync</a> 方法時，請記得為 <em>useSingleSignOn</em> 提供 <strong>true</strong> 值。這可讓您的使用者在使用 Microsoft 帳戶時有更理想的登入體驗。
