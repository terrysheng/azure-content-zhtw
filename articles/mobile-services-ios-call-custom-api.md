...
本教學課程會以行動服務快速入門為基礎。在開始本教學課程之前，您必須首先完成[開始使用行動服務]。本教學課程需要[行動服務 iOS SDK](https://go.microsoft.com/fwLink/p/?LinkID=266533) 與 [XCode 4.5](https://go.microsoft.com/fwLink/p/?LinkID=266532) 和 iOS 5.0 或更新版本。
