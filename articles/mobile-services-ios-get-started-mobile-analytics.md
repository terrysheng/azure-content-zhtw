<properties urlDisplayName="Get Started with Mobile Analytics" pageTitle="開始使用行動分析 | 行動開發人員中心" metaKeywords="" description="Get Started with Mobile Analytics." metaCanonical="" disqusComments="1" umbracoNaviHide="1" documentationCenter="Mobile" title="Get Started with Mobile Analytics" authors="mahender" manager="dwrede"/>
...
5. 在 `applicationDidFinishLaunching:` 或 `application:didFinishLaunchingWithOptions:` 內部，按下內含您的應用程式識別碼和 SDK 金鑰的 `registerapp:identifiedby:` 來初始化 Capptain 代理程式。
