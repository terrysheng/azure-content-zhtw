<properties pageTitle="使用行動服務將資料儲存在資料表儲存體中 | 行動服務" description="了解如何使用行動服務將資料儲存在資料表儲存體中。" documentationCenter="ios" authors="ysxu" writer="yuaxu" services="mobile-services, storage" manager="dwrede" editor=""/>
