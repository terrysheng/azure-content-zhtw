...
<div class="dev-center-tutorial-subselector">
	<a href="/documentation/articles/mobile-services-dotnet-backend-store-code-source-control/" title=".NET backend">.NET 後端</a> | <a href="/documentation/articles/mobile-services-store-scripts-source-control/"  title="JavaScript backend" class="current">JavaScript 後端</a>
</div>
...
[開始使用行動服務]: /documentation/articles/mobile-services-ios-get-started/
[將行動服務新增至現有的應用程式]: /documentation/articles/mobile-services-ios-get-started-data/
[在行動服務中使用伺服器指令碼]: /documentation/articles/mobile-services-how-to-use-server-scripts/
[Azure 管理入口網站]: https://manage.windowsazure.com/
[從用戶端呼叫自訂 API]: /documentation/articles/mobile-services-ios-call-custom-api/
