...
2. 在 [服務管理員] 對話方塊中，按一下 [建立服務]****，然後在 [建立行動服務] 對話方塊的 [訂閱]**** 中，選取 [&lt;匯入...&gt;]****。
	...
	![從 VS 2013 建立新的行動服務](./media/mobile-services-create-new-service-vs2013/mobile-create-service-from-vs2013.png)

3. 在 [匯入 Azure 訂閱] 中按一下 [下載訂閱檔案]****，登入您的 Azure 帳戶 (如有必要)，在瀏覽器要求儲存檔案時，按一下 [儲存]****。

	![在 VS 中下載訂閱檔案](./media/mobile-services-create-new-service-vs2013/mobile-import-azure-subscription.png)
...
4. 按一下 [瀏覽]**** 並瀏覽至儲存 .publishsettings 檔案的位置，選取此檔案，然後依序按一下 [開啟]****、[匯入]****。
	...
	![在 VS 中匯入訂閱](./media/mobile-services-create-new-service-vs2013/mobile-import-azure-subscription-2.png)
