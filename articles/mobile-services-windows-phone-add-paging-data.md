...
本教學課程會以上一堂教學課程[開始使用資料](/en-us/documentation/articles/mobile-services-windows-phone-get-started-data/)中的步驟和範例應用程式為基礎。開始進行此教學課程之前，您至少必須先完成資料序列中的第一個教學課程[開始使用資料](/en-us/documentation/articles/mobile-services-windows-phone-get-started-data/)。
...
-   [開始使用推播通知](/en-us/documentation/articles/mobile-services-windows-phone-get-started-push/)
