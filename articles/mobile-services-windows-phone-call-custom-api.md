...
本教學課程的基礎是 GetStartedWithData 範例 (簡單的 TodoList 應用程式)。在開始本教學課程之前，您必須先完成[將行動服務新增至現有的應用程式](/zh-tw/documentation/articles/mobile-services-windows-phone-get-started-data/)。
