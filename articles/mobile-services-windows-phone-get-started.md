...
本主題已不再支援；無法再從入口網站下載 Windows Phone 8.0 快速啟動專案。如需將行動服務新增至現有的 Windows Phone 8.0 或 Windows Phone 8.1 Silverlight 應用程式，請參閱[新增行動服務至現有應用程式主題](/zh-tw/documentation/articles/mobile-services-windows-phone-get-started-data/)。 
