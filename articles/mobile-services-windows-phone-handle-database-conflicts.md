<properties pageTitle="以開放式並行存取處理資料庫寫入衝突 (Windows 市集) | 行動開發人員中心" description="了解如何處理伺服器與 Windows 市集應用程式之間的資料庫寫入衝突。" documentationCenter="windows" authors="wesmc7777" manager="dwrede" editor="" services=""/>
