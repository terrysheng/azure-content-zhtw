...
2.  [更新插入指令碼以產生 SAS][更新插入指令碼以產生 SAS]
3.  [更新用戶端應用程式以擷取影像][更新用戶端應用程式以擷取影像]
4.  [上傳影像以測試應用程式][上傳影像以測試應用程式]

本教學課程需要下列各項：

-   Microsoft Visual Studio 2012 Express for Windows 8 或更新版本
-   [Windows Phone SDK 8.0][Windows Phone SDK 8.0] (英文) 或更高版本
...
-   [使用 SendGrid 從行動服務傳送電子郵件][使用 SendGrid 從行動服務傳送電子郵件]

  了解如何使用 SendGrid 電子郵件服務將電子郵件功能新增到行動服務本主題示範如何新增伺服器端指令碼，以使用 SendGrid 傳送電子郵件。

-   [在行動服務中排程後端工作][在行動服務中排程後端工作]
