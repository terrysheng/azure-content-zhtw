<properties pageTitle="使用分頁縮小行動服務查詢範圍 (Windows 市集) | 行動開發人員中心" description="了解如何使用分頁來管理行動服務傳回您 Windows 市集應用程式的資料量。" services="mobile-services" documentationCenter="windows" authors="ggailey777" manager="dwrede" editor=""/>
