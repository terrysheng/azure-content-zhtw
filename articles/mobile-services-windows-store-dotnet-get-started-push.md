...
[.NET 後端](/en-us/documentation/articles/mobile-services-dotnet-backend-windows-store-dotnet-get-started-push/ ".NET 後端") | [JavaScript 後端](/en-us/documentation/articles/mobile-services-windows-store-dotnet-get-started-push/ "JavaScript 後端")
...
> [WACOM.NOTE]行動服務現在與 Azure 通知中心整合，以支援其他推播通知功能，例如範本、多個平台和範圍。這項整合後的功能目前只能預覽。如需詳細資訊，請參閱這一版的[開始使用推播通知](/en-us/documentation/articles/mobile-services-javascript-backend-windows-store-dotnet-get-started-push/)。
