...
-   Visual Studio 2013 可讓您更輕鬆地連接 Windows 市集應用程式與行動服務。若要使用 Visual Studio 2012 完成相同的基本程序，請依照主題[使用 Visual Studio 2012 開始使用行動服務中的資料][使用 Visual Studio 2012 開始使用行動服務中的資料]中的步驟進行。
