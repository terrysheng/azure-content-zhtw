...
在下一個[行動服務使用者的伺服器端授權][使用指令碼授權使用者]教學課程中，您將使用由行動服務根據經驗證的使用者而提供的使用者識別碼值，來篩選行動服務傳回的資料。 
...
[開始使用推播通知]: mobile-services-windows-store-javascript-get-started-push.md
[使用指令碼授權使用者]: mobile-services-windows-store-javascript-authorize-users-in-scripts.md

[Azure 管理入口網站]: https://manage.windowsazure.com/
[註冊 Windows 市集應用程式封裝以進行 Microsoft 驗證]: /develop/mobile/how-to-guides/register-windows-store-app-package
