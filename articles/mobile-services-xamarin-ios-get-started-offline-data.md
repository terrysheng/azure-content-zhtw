...
-   [Azure 行動服務 SDK 1.3.0-alpha3 版 (或更新版本)][Azure 行動服務 SDK 1.3.0-alpha3 版 (或更新版本)]
-   [Azure 行動服務 SQLite Store 1.0.0-alpha2 版 (或更新版本)][Azure 行動服務 SQLite Store 1.0.0-alpha2 版 (或更新版本)]

> [WACOM.NOTE] 下列指示假設您使用附有 Xamarin 延伸的 Visual Studio 2012 或更新版本。如果您在 OS X 上使用 Xamarin Studio，則指示大致上都相同，但您應同時安裝 [NuGet Addin for Xamarin][NuGet Addin for Xamarin]，以便能輕鬆地將搶鮮版行動服務 NuGet 封裝新增至您的專案。
