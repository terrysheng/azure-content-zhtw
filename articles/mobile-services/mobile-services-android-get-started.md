...
<p>本教學課程顯示如何使用 Azure 行動服務，將雲端型後端服務新增到 Android 應用程式。在本教學課程中，您將建立新的行動服務，並建立可在新的行動服務中儲存應用程式資料的簡單 <em>To do list</em> (待辦事項) 應用程式。</p>
...
如果您想查看已完成之應用程式的原始程式碼，請移至[這裡](https://github.com/RickSaling/mobile-services-samples/tree/androidStudio/GettingStarted/AndroidStudio)。
...
<!-- URLs. -->
[開始使用 (Eclipse)]: mobile-services-android-get-started-EC.md
