...
>[AZURE.TIP]如果您是使用 Microsoft Azure 進行行動開發的新手，請參閱[開始使用 Azure Mobile Apps](app-service-mobile-dotnet-backend-xamarin-ios-get-started-preview.md) 而非 Azure 行動服務；Mobile Apps 可讓您有[更多優勢](app-service-mobile-value-prop-migration-from-mobile-services-preview.md)。
