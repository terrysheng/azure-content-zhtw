...
>[AZURE.NOTE]本教學課程支援 Windows Phone 8.0 和 Windows Phone 8.1 Silverlight 應用程式。如需 Windows Phone 8.1 市集應用程式，請參閱[本主題的 Windows 市集版本](mobile-services-javascript-backend-windows-store-dotnet-push-notifications-app-users.md)。
...
&nbsp;&nbsp;此 insert 指令碼會使用「使用者識別碼標記」傳送推播通知 (包含插入項目的文字) 給已登入的使用者建立的所有 Windows Phone (MPNS) 應用程式註冊。
