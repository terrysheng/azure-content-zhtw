...
本教學課程支援 Windows Phone 8.0 和 Windows Phone 8.1 Silverlight 應用程式。如需 Windows Phone 8.1 市集應用程式，請參閱[本主題的 Windows 市集版本](mobile-services-javascript-backend-windows-store-dotnet-push-notifications-app-users.md)。
...
[開始使用推播通知]: mobile-services-javascript-backend-windows-phone-get-started-push.md
