...
您會將此功能新增至您完成[將行動服務新增至現有的應用程式](mobile-services-windows-phone-get-started-data.md)教學課程時所建立的應用程式。本教學課程以 GetStartedWithData 範例 (簡單的 TodoList 應用程式) 為基礎。在開始本教學課程之前，您必須先完成[將行動服務新增至現有的應用程式](mobile-services-windows-phone-get-started-data.md)。
