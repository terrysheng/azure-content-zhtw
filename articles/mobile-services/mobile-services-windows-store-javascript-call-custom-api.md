...
本主題示範如何使用 **invokeApi** 函數從您的 Windows 應用程式呼叫相當簡單的自訂 API。若要深入了解使用 **invokeApi** 函數，請參閱 [Azure 行動服務中的自訂 API](http://blogs.msdn.com/b/carlosfigueira/archive/2013/06/19/custom-api-in-azure-mobile-services-client-sdks.aspx) 文章。
...
[新增行動服務至現有應用程式]: mobile-services-windows-store-javascript-get-started-data.md
