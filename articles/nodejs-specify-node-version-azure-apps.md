...
Azure 目前提供 Node.js 0.6.17、0.6.20 和 0.8.4 版。除非另有指定，0.6.20 將是使用的預設版本。
...
2.  建立新網站並記下網站的名稱。例如，以下使用 [Azure 命令列工具](/en-us/develop/nodejs/how-to-guides/command-line-tools/)建立新的 Azure 網站 (名稱為 **mywebsite**)，然後編輯該網站的 Git 存放庫。
...
您已了解如何指定應用程式使用的 Node.js 版本，現在請了解如何[使用模組](/en-us/develop/nodejs/common-tasks/working-with-node-modules/)、[建置並部署 Node.js 網站](/en-us/develop/nodejs/tutorials/create-a-website-(mac)/)和[如何使用適用於 Mac 和 Linux 的 Azure 命令列工具](/en-us/develop/nodejs/how-to-guides/command-line-tools/)。
