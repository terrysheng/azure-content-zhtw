...
> [AZURE.NOTE] 本教學課程假設您已建立並設定通知中樞，如[開始使用通知中心 (Android)](notification-hubs-android-get-started.md) 中所述。 
> 如果您使用行動服務作為後端服務，請參閱本教學課程的[行動服務版本](mobile-services-javascript-backend-android-push-notifications-app-users.md)。
