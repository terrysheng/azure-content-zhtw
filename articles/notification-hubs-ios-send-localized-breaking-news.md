...
<tags 
	...
	ms.date="02/26/2015" 
	ms.author="wesmc"/>
# 使用通知中樞將當地語系化的即時新聞傳送至 iOS 裝置

<div class="dev-center-tutorial-selector sublanding">
    	<a href="/documentation/articles/notification-hubs-windows-store-dotnet-send-localized-breaking-news/" title="Windows Store C#">Windows 市集 C#</a><a href="/documentation/articles/notification-hubs-ios-send-localized-breaking-news/" title="iOS" class="current">iOS</a>
</div>
...
範本的功能非常強大，您可以在[通知中樞指引]一文中了解詳情。如需範本運算式語言的參考，請參閱我們的[做法：服務匯流排通知中樞 (iOS 應用程式)]。
...
[推播通知給應用程式使用者]: /develop/mobile/tutorials/push-notifications-to-users-ios
[使用指令碼授權使用者]: /develop/mobile/tutorials/authorize-users-in-scripts-ios
[JavaScript 和 HTML]: /develop/mobile/tutorials/get-started-with-push-js.md
