...
2.  使用 Sencha Cmd 執行以下命令：
    ...
    -   *sencha app refresh*：這會指示 Sencha Cmd 找出所有的應用程式相依性，
        並下載任何需要的封裝 (例如 [Sencha Touch Extensions for Azure][這裡])。
...
<!-- images -->
  ...
  [觀看教學課程]: http://go.microsoft.com/fwlink/?LinkId=392574
  ...
  [這裡]: https://market.sencha.com/extensions/sencha-touch-extensions-for-windows-azure
  [Sencha Cmd 套件]: http://docs.sencha.com/cmd/3.1.2/#!/guide/command_packages
  [開始使用 Ext.Azure]: http://senchaazuredocs.azurewebsites.net/#!/guide/getting_started
  ...
  [下載]: https://github.com/arthurakay/sencha-touch-azure-example
  [逐步解說]: http://docs.sencha.com/touch-azure/1.0.0/#!/guide/data_filters
  [Sencha 論壇]: http://www.sencha.com/forum
  [Sencha 文件]: http://docs.sencha.com/
  [(視訊)]: http://channel9.msdn.com/Shows/Cloud+Cover/Episode-126-Using-Sencha-With-Windows-Azure-Mobile-Services
