<properties urlDisplayName="How to Make a Phone Call from Twilio in Java" pageTitle="如何從 Twilio (Java) 撥打電話 - Azure " metaKeywords="Azure Twilio 通話, Twilio 通話網站, Azure Twilio Java" description="了解如何在 Azure 上的 Java 應用程式中使用 Twilio 從網頁撥打電話。" metaCanonical="" services="" documentationCenter="Java" title="How to Make a Phone Call Using Twilio in a Java Application on Azure" authors="MicrosoftHelp@twilio.com; robmcm" videoId="" scriptId="" solutions="" manager="twilio" editor="mollybos" />
