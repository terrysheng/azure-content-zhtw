...
當應用程式開始呼叫 Twilio API 時 (例如，透過 client.InitiateOutboundCall 方法)，Twilio 會傳送要求至 URL，然後應該會傳回 TwiML 回應。作法：撥出電話的範例會使用 Twilio 提供的 URL <http://twimlets.com/message> 來傳回回應。

<div class="dev-callout">
<b>注意</b>
<p>雖然 TwiML 是專供 Web 服務使用，但您也可以在瀏覽器中檢視 TwiML。例如，您可以按一下 <a href="http://twimlets.com/message">twimlet_message_url</a> 以檢視空的 &lt;Response&gt; 元素，或按一下 <a href="http://twimlets.com/message?Message%5B0%5D=Hello%20World">twimlet_message_url_hello_world</a> 以檢視包含 &lt;Say&gt; 元素的 &lt;Response&gt; 元素。</p>
</div>
...
如需 TwiML 的詳細資訊，請參閱 [][1]<https://www.twilio.com/docs/api/twiml></a>。
