<properties 
	pageTitle="在指令碼中授權使用者 (Xamarin.Android) - Azure 行動服務" 
	description="了解如何在 Xamarin.Android 的 Azure 行動服務應用程式中使用指令碼驗證使用者。" 
	authors="lindydonna" 
	manager="dwrede" 
	editor="" 
...
5. 返回[管理入口網站][Azure 管理入口網站]中的 **todoitem** 資料表，按一下 **[瀏覽]** 並驗證每個新增項目現在是否具有關聯的 userId 值。
