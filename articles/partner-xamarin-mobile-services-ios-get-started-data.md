...
<p>This tutorial is intended to help you better understand how Mobile Services enables you to use Azure to store and retrieve data from a Xamarin.iOS app. As such, this topic walks you through many of the steps that are completed for you in the Mobile Services quickstart. If this is your first experience with Mobile Services, consider first completing the tutorial <a href="/zh-tw/develop/mobile/tutorials/get-started-xamarin-ios">Get started with Mobile Services</a>.</p>
</div>
...
[Validate and modify data with scripts]: /zh-tw/develop/mobile/tutorials/validate-modify-and-augment-data-xamarin-ios
[Refine queries with paging]: /zh-tw/develop/mobile/tutorials/add-paging-to-data-xamarin-ios
