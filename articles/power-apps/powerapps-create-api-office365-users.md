...
7. 在 [**來源**] 中，選取 [**可用 API**] 以選取預先建置的 API，然後選取 [**Office 365 使用者**]：![選取 Office 365 使用者 api][3]

8. 選取 [**設定 - 進行必要的設定**]：![進行 Office 365 使用者 API 設定][4]
...
8. 將 [_OAuth 2_] 區段下方的[**回覆 URL**] 設為您在 Azure 入口網站中新增 Office 365 使用者 API 時收到的重新導向 URL (在本主題中)。選取 [**新增應用程式**]：![設定 Contoso AAD 應用程式][11]
...
[Office 365 使用者 REST API](../connectors/connectors-create-api-office365-users.md) 參考。
