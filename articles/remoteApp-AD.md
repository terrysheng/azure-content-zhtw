<properties title="Configure Active Directory for Azure RemoteApp" pageTitle="設定 Azure RemoteApp 的 Active Directory" description="了解如何設定 Active Directory 來與 Azure RemoteApp 搭配使用" metaKeywords="" services="" solutions="" documentationCenter="" authors="elizapo"  />
...
還未將 Active Directory 網域服務新增至您的 Windows Server 2012 R2 環境嗎？如需如何進行的資訊，請查看[這些指示](http://technet.microsoft.com/zh-tw/library/cc731053(v=WS.10).aspx)。
###檢查及設定 UPN 網域尾碼
...
- [新增網域](http://technet.microsoft.com/zh-tw/library/hh969247.aspx) - 請使用此資訊來新增一個網域，以符合內部部署之 Active Directory 網域的 UPN 網域尾碼。
- [目錄整合](http://technet.microsoft.com/zh-tw/library/jj573653.aspx) - 請使用此資訊來選擇目錄整合選項 - [含密碼同步化的 DirSync](http://technet.microsoft.com/zh-tw/library/dn441214.aspx) 或[含同盟的 DirSync](http://technet.microsoft.com/zh-tw/library/dn441213.aspx)。

您也可以設定 [Multi-Factor Authentication (MFA)](http://technet.microsoft.com/zh-tw/library/dn249466.aspx)。
