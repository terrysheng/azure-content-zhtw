<properties title="Azure RemoteApp best practices" pageTitle="Azure RemoteApp 最佳做法" description="設定及使用 RemoteApp 的最佳做法。" metaKeywords="" services="" solutions="" documentationCenter="" authors="elizapo"  />
...
- 在 Azure RemoteApp 中使用自訂應用程式之前，請先進行驗證。這包括確認它們可在多重工作階段的平台上運作，而且不會使用不必要的資源，例如可能使同一收藏中的其他使用者缺乏的記憶體和 CPU。如需詳細資訊，請下載並檢閱[遠端桌面服務的應用程式相容性最佳做法](http://www.microsoft.com/zh-tw/download/details.aspx?id=18704)。 
