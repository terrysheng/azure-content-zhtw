...
**注意：**如果您想要從 [開始] 功能表新增您的應用程式，您必須*先將該應用程式新增至您範本映像上的 [開始] 功能表。* 否則，RemoteApp 只會看到*實際*在 [開始] 功能表上的項目，而您會覺得很困惑。如果您忘記在建立範本時將應用程式新增到 [開始] 功能表，請選擇新增路徑到應用程式。(或者重新建立您的範本映像，但是這會比較費工。)
