<properties
   pageTitle="在任何裝置上取得相同的 Office 365 體驗"
   description="了解如何使用 RemoteApp 與使用者共用任何 Office 365 應用程式。"
   services="remoteapp"
   documentationCenter=""
   authors="guscatalano"
   manager="mbaldwin"
...
在 Azure 中使用者可連接的可調整虛擬機器上裝載 Office 365，即可使用 Azure RemoteApp 完成這項作業。這組虛擬機器稱為「雲端集合」。
