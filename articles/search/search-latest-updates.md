...
[Lucene 查詢語法支援](https://msdn.microsoft.com/library/azure/mt589323.aspx)|2016 年 2 月|[GA](search-api-2015-02-28.md)|現在 REST API 和 .NET SDK 中都已經可以使用 Lucene 查詢語法。請在 REST API 中將 `queryType` 參數設定為 `full`，以及在 .NET SDK 中將 `SearchParameters.QueryType` 屬性設定為 `QueryType.Full`，以啟用 Lucene 語法。
