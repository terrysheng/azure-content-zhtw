...
8. 開啟想要查看的 [建議]，當做安全性原則的一部分。範例：
  ...
  - 開啟 [基準規則] 會掃描所有支援的虛擬機器，識別任何可能讓虛擬機器更容易受到攻擊的作業系統設定。

![Azure 資訊安全中心的 [安全性原則] 磚][3]

處理**建議**：

9. 返回 [資訊安全中心] 刀鋒視窗，然後按一下 [建議] 磚。資訊安全中心會定期分析 Azure 資源的安全性狀態。發現潛在的安全性弱點時，會在這裡顯示建議。
...
14.	請選取 [虛擬機器] 檢視詳細資訊。
15.	[虛擬機器] 刀鋒視窗會顯示狀態摘要，其中顯示反惡意程式碼程式、系統更新、重新啟動的狀態與虛擬機器的基準規則。
16.	在 [預防步驟] 下選取項目，檢視詳細資訊及/或採取行動以設定必要的控制項。
17.	向下鑽研以檢視特定虛擬機器的其他資訊。

![Azure 資訊安全中心的 [資源健康狀態] 磚][5]

處理**安全性警示**：

19.	返回 [資訊安全中心] 刀鋒視窗，然後按一下 [安全性警示] 磚。[安全性警示] 刀鋒視窗中會顯示警示清單。資訊安全中心透過對安全性記錄檔和網路活動的分析，產生警示。也包含來自整合式合作夥伴解決方案的警示。![Azure 資訊安全中心的安全性警示][6]

21.	按一下警示以檢視其他資訊。

  ![Azure 資訊安全中心的安全性警示詳細資料][7]
