...
+ C 開發環境。在本教學課程中，我們假設 [Azure Linux VM](http://azure.microsoft.com/zh-tw/documentation/articles/virtual-machines-linux-tutorial/)上的 gcc 堆疊有 Ubuntu 14.04。其他環境的指示將會在外部連結中提供。
