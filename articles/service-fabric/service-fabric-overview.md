...
Service Fabric 提供技術支援給目前許多的 Microsoft 服務，包括 Azure SQL Database、Azure DocumentDB、Cortana、Power BI、Microsoft Intune、Azure 事件中樞、Azure IoT，以及許多核心 Azure 服務和商務用 Skype 等等。
...
如需有關微服務方法的詳細資訊，請閱讀文章[為何要用微服務方式建置應用程式？](service-fabric-overview-microservices.md)
...
- 使用 Service Fabric 程式設計模型，開發由微服務，或僅主機來賓可執行檔，以及您所選擇的其他應用程式架構 (例如 ASP.NET、Nodejs 等) 組成的應用程式。
