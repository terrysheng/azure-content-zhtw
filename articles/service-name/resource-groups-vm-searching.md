...
現在，您可以精確地選擇想要使用的映像。若要使用您剛找到的 URN 資訊快速地建立 VM，或使用具有該 URN 資訊的範本，請參閱[搭配使用適用於 Mac、Linux 和 Windows 的 Azure CLI 與 Azure 資源管理](virtual-machines/xplat-cli-azure-resource-manager.md)。
