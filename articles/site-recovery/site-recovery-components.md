...
- 如果防火牆上有 IP 位址架構規則，請確定它們允許設定伺服器至 [Azure 資料中心 IP 範圍](https://www.microsoft.com/download/details.aspx?id=41653) (英文) 所述的 IP 位址通訊，並適用於HTTPS (443)。您必須列名於計劃使用的 Azure 區域和美國西部的允許清 IP 位址範圍。
