...
**工作負載** | <p>**複寫 Hyper-V VM**</p> <p>**(至次要站台)**</p> | <p>**複寫 Hyper-V VM**</p> <p>**(至 Azure)**</p> | <p>**複寫 VMware VM**</p> <p>**(至次要站台)**</p> | <p>**複寫 VMware VM**</p><p>**(至 Azure)****</p>
---|---|---|---|---
Active Directory、DNS | Y | Y | Y | Y 
Web 應用程式 (IIS、SQL) | Y | Y | Y | Y
SCOM | Y | Y | Y | Y
Sharepoint | Y | Y | Y | Y
<p>SAP</p><p>將 SAP 站台複寫至非叢集的 Azure </p> | Y (由 Microsoft 測試) | Y (由 Microsoft 測試) | Y (由 Microsoft 測試) | Y (由 Microsoft 測試)
