...
您可以使用 Visual Studio 中的所有相同設計工具來處理 SQL Database，如同您對 SQL Server 的處理一般。[伺服器總管] 可讓您
檢視 (但無法編輯) 資料庫物件。Visual Studio 的實體資料模型設計工具具有完備的功能，可讓您對 SQL Database 建立用於 Entity Framework 的模型。
