<properties urlDisplayName="SQL Database" pageTitle="如何使用 SQL Database (.NET) - Azure 功能指南" metaKeywords="開始使用 SQL Azure, 開始使用 SQL Azure, SQL Azure 資料庫連接, SQL Azure ADO.NET, SQL Azure ODBC, SQL Azure EntityClient" description="開始使用 SQL Database。了解如何建立 SQL Database 執行個體並使用 ADO.NET、ODBC 和 EntityClient Provider 進行連線。" metaCanonical="" services="sql-database" documentationCenter=".NET" title="How to use Azure SQL Database in .NET applications" authors="jeffreyg" solutions="" manager="jeffreyg" editor="" />
