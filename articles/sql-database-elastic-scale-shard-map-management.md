<properties title="Shard Map Management" pageTitle="分區對應管理" description="如何使用 ShardMapManager (Elastic Scale API for .NET)" metaKeywords="sharding scaling, Azure SQL Database sharding, elastic scale, shardmapmanager" services="sql-database" documentationCenter="" manager="jhubbard" authors="sidneyh@microsoft.com"/>
