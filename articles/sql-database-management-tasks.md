...
<h2><a id="connect"></a>作法：使用 Management Studio 連接到 Azure 中的 SQL Database</h2>
...
2. 選擇 [**連接埠**]，指定 TCP 1433，指定 [**允許連接**]，並確定已選取 [**公用**] 設定檔。
...
<h2><a id="addlogins"></a>作法：將登入和使用者新增至 Azure 中的 SQL Database</h2>
