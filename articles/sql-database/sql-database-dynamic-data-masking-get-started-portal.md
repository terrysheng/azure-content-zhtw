...
> [AZURE.SELECTOR]
- [動態資料遮罩 - Azure Preview 入口網站](sql-database-dynamic-data-masking-get-started.md)
...
| **身分證號碼** |**遮罩方法公會開指定欄位的末兩碼**，並新增常數字串做為美國社會安全碼格式的前置詞。<br/><br/>XXX-XX-XX12 |
...
| **自訂文字** |**遮罩方法會公開第一個和最後一個字母**，並在中間新增自訂填補字串。<br/>前置詞[填補]尾碼<br/><br/>![導覽窗格][Image2] |
...
1. 在 [https://manage.windowsazure.com](https://manage.windowsazure.com) 啟動 Azure 入口網站。
