...
- [地理還原 - REST API](http://azure.microsoft.com/documentation/articles/sql-database-geo-restore-tutorial-rest/)   

## 概觀

本教學課程會向您示範如何使用 [Azure PowerShell](http://azure.microsoft.com/documentation/articles/install-configure-powershell/) 中的地理還原來復原 Azure SQL Database。地理還原是所有 Basic、Standard 及 Premium Azure SQL Databases 服務層皆包含的核心災害復原保護技術。
...
您必須使用憑證式認證來執行下列 Cmdlet。如需詳細資訊，請參閱[如何安裝及設定 Azure PowerShell](http://azure.microsoft.com/documentation/articles/install-configure-powershell/#use-the-certificate-method) 中的 *使用憑證方法*一節
