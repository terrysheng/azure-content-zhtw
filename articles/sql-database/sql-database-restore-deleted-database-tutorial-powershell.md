...
- [還原已刪除的資料庫 - REST API](http://azure.microsoft.com/documentation/articles/sql-database-restore-deleted-database-tutorial-rest/)

## 概觀

本教學課程會向您示範如何還原 [Azure PowerShell](http://azure.microsoft.com/documentation/articles/install-configure-powershell/) 中已刪除的 Azure SQL Database。您可以將在其保留期間內被刪除的資料庫還原至其被刪除時的時間點。保留期間是由資料庫的服務層決定。
