<properties urlDisplayName="How to create" pageTitle="如何建立儲存體帳戶 | Azure" metaKeywords="" description="了解如何在 Azure 管理入口網站中建立儲存體帳戶。" metaCanonical="" services="storage" documentationCenter="" title="如何建立儲存體帳戶" solutions="" authors="tamram" manager="adinah" editor="cgronlun" />
