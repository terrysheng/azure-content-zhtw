...
-   僅限寄送硬碟機。請勿加入電源線或 USB 纜線等項目。
  ...
  [Azure 匯入/匯出服務 REST API 參考]: http://go.microsoft.com/fwlink/?LinkID=329099
  [如何建立儲存體帳戶]: ../storage-create-storage-account/
  [Microsoft Azure 匯入/匯出工具參考]: http://go.microsoft.com/fwlink/?LinkId=329032
  [Microsoft Azure 匯入/匯出工具]: http://go.microsoft.com/fwlink/?LinkID=301900&clcid=0x409
