...
-   [必要條件][必要條件]
-   [如何使用 Blob 服務與 Hudson CI][如何使用 Blob 服務與 Hudson CI]
...
## <span id="overview"></span></a><span class="short header">概觀</span>Hudson 概觀
...
您可以在[認識 Hudson][認識 Hudson] (英文) 中找到有關 Hudson 的詳細資訊。

## <span id="benefits"></span></a><span class="short header">優點</span>使用 Blob 服務的優點
...
## <span id="prerequisites"></span></a><span class="short header">必要條件</span>必要條件
...
## <span id="howtouse"></span></a><span class="short header">如何使用 Blob 服務</span>如何使用 Blob 服務與 Hudson CI

若要使用 Blob 服務與 Hudson，您必須安裝 Azure 儲存體外掛程式，設定此外掛程式使用您的儲存體帳戶，然後建立可將組建成品上傳至儲存體帳戶的建置後動作。這些步驟將於下列各節中說明。

## <span id="howtoinstall"></span></a><span class="short header">如何安裝</span>如何安裝 Azure 儲存體外掛程式
...
## <span id="howtoconfigure"></span></a><span class="short header">如何設定</span>如何設定 Azure 儲存體外掛程式來使用您的儲存體帳戶
...
## <span id="howtocreatepostbuild"></span></a><span class="short header">如何建立建置後動作</span>如何建立會將您的組建成品上傳至您儲存體帳戶的建置後動作
...
## <span id="components"></span></a><span class="short header">Blob 服務元件</span>Blob 服務所使用的元件
