...
-   Microsoft Network Monitor (Netmon) (<http://www.microsoft.com/en-us/download/details.aspx?id=4865>) 與 Wireshark (<http://www.wireshark.org/>) 都是免費提供的網路通訊協定分析器，可讓您針對廣泛的網路通訊協定檢視其詳細封包資訊。如需有關 Wireshark 的詳細資訊，請參閱「[附錄 2：使用 Wireshark 擷取網路流量][附錄 2：使用 Wireshark 擷取網路流量]」。
...
<td>資訊</td>
    <td>3</td>
<td>85d077ab -…</td>
<td>開始將要求同步至 https://domemaildist.blob.core.windows.netazure<br>imblobcontainer/blobCreatedViaSAS.txt?
...
<!--Image references-->
  ...
  [儲存體分析度量表結構描述]: http://msdn.microsoft.com/en-us/library/azure/hh343264.aspx
  ...
  [常見的 REST API 錯誤碼]: http://msdn.microsoft.com/en-us/library/azure/dd179357.aspx
  [Blob 服務錯誤碼]: http://msdn.microsoft.com/en-us/library/azure/dd179439.aspx
  [佇列服務錯誤碼]: http://msdn.microsoft.com/en-us/library/azure/dd179446.aspx
  [資料表服務錯誤碼]: http://msdn.microsoft.com/en-us/library/azure/dd179438.aspx
  ...
  [偵錯、追蹤與分析]: http://msdn.microsoft.com/en-us/library/7fe0dd2y(v=vs.110).aspx
  ...
  [Microsoft.WindowsAzure.Storage.RetryPolicies 命名空間]: http://msdn.microsoft.com/en-us/library/microsoft.windowsazure.storage.retrypolicies.aspx
  ...
  [使用共用存取簽章來委派存取權]: http://msdn.microsoft.com/en-us/library/azure/ee395415.aspx
  ...
  [Windows Azure 儲存體服務的跨原始來源資源分享 (CORS)]: http://msdn.microsoft.com/en-us/library/windowsazure/dn535601.aspx
  ...
  [儲存體模擬器與 Azure 儲存體服務之間的差異]: http://msdn.microsoft.com/en-us/library/gg433135.aspx
  [使用命令列工具初始化儲存體模擬器]: http://msdn.microsoft.com/en-us/library/gg433132.aspx
  ...
  [PEF-WebProxy 供應商]: http://technet.microsoft.com/en-us/library/jj674814.aspx
  ...
  [PEF-NDIS-PacketCapture 供應商]: http://technet.microsoft.com/en-us/library/jj659264.aspx
  [儲存體分析記錄格式]: http://msdn.microsoft.com/en-us/library/hh343259.aspx
  [儲存體分析度量資料表結構描述]: http://msdn.microsoft.com/en-us/library/hh343264.aspx
  [MSDN 上的 Application Insights for Visual Studio Online]: http://msdn.microsoft.com/en-us/library/dn481095.aspx
