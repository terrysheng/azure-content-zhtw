<properties title="如何使用佇列服務 (PHP) - Azure 功能指南" pageTitle="如何使用佇列服務 (PHP) | Microsoft Azure" metaKeywords="Azure Queue Service messaging PHP" description="了解如何使用 Azure 佇列服務來建立和刪除佇列，以及插入、取得和刪除訊息。範例以 PHP 撰寫。" documentationCenter="PHP" services="storage" authors="tamram" manager="adinah" />
...
## <span id="connection-string"></span></a>設定 Azure 儲存體連線
...
## <span id="create-queue"></span></a>作法：建立佇列
...
## <span id="add-message"></span></a>作法：將訊息新增至佇列
...
## <span id="peek-message"></span></a>作法：查看下一個訊息
...
## <span id="dequeue-message"></span></a>作法：將下一個訊息清除佇列
...
## <span id="change-message"></span></a>作法：變更佇列訊息的內容
...
## <span id="additional-options"></span></a>其他將訊息移出佇列的選項
...
## <span id="get-queue-length"></span></a>作法：取得佇列長度
...
## <span id="delete-queue"></span></a>作法：刪除佇列
