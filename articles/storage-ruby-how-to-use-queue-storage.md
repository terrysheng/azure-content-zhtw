...
## <span id="how-to-create-a-queue"></span></a>作法：建立佇列
...
## <span id="how-to-insert-a-message-into-a-queue"></span></a>作法：將訊息插入佇列

若要將訊息插入佇列中，請使用 **create\_message()** 方法建立新訊息，並將其新增至佇列。

    azure_queue_service.create_message("test-queue", "test message")

## <span id="how-to-peek-at-the-next-message"></span></a>作法：查看下一個訊息
...
## <span id="how-to-dequeue-the-next-message"></span></a>作法：清除下一個佇列訊息
...
## <span id="how-to-change-the-contents-of-a-queued-message"></span></a>作法：變更佇列訊息的內容
...
## <span id="how-to-additional-options-for-dequeuing-messages"></span></a>作法：清除佇列訊息的其他選項
...
## <span id="how-to-get-the-queue-length"></span></a>作法：取得佇列長度
...
## <span id="how-to-delete-a-queue"></span></a>作法：刪除佇列
