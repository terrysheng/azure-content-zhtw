...
本指南將示範如何使用 Azure 資料表服務執行一般案例。這些範例使用 Ruby API 撰寫。涵蓋的案例包括**「建立和刪除資料表」、「在資料表中插入及查詢實體」**。如需資料表的詳細資訊，請參閱[後續步驟](#next-steps) 一節。
...
* [作法：建立資料表](#how-to-create-a-table)
* [作法：將實體新增至資料表](#how-to-add-an-entity-to-a-table)
* [作法：更新實體](#how-to-update-an-entity)
* [作法：使用實體群組](#how-to-work-with-groups-of-entities)
* [作法：查詢實體](#how-to-query-for-an-entity)
* [作法：查詢實體集合](#how-to-query-a-set-of-entities)
...
建立 Ruby 應用程式。如需指示，請參閱在 [Azure 上建立 Ruby 應用程式](/zh-tw/develop/ruby/tutorials/web-app-with-linux-vm/)。
...
## <a id="how-to-update-an-entity"></a>作法：更新實體
...
## <a id="how-to-work-with-groups-of-entities"></a>作法：使用實體群組
...
## <a id="how-to-query-for-an-entity"></a>作法：查詢實體
...
## <a id="how-to-query-a-set-of-entities"></a>作法：查詢實體集合
...
## <a id="how-to-query-a-subset-of-entity-properties"></a>作法：查詢實體屬性的子集
...
* 造訪 [Azure SDK for Ruby](http://github.com/WindowsAzure/azure-sdk-for-ruby) GitHub 上的儲存機制
