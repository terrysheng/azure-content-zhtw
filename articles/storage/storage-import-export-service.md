...
7. 若要在寄出包裹之後輸入追蹤號碼，請在管理入口網站中回到您的儲存體帳戶的 [匯入/匯出] 頁面，從清單中選取工作，然後選擇 [傳送資訊]。逐步執行精靈，在步驟 2 中輸入追蹤號碼。
...
6. 若要在寄出包裹之後輸入追蹤號碼，請在管理入口網站中回到您的儲存體帳戶的 [匯入/匯出] 頁面，從清單中選取工作，然後選擇 [傳送資訊]。逐步執行精靈，在步驟 2 中輸入追蹤號碼。
