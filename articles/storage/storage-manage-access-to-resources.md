...
| REST 作業                                         | 具有完整公開讀取權限 | 僅具有 Blob 的公開讀取權限 |
|--------------------------------------------------------|-----------------------------------------|---------------------------------------------------|
| 列出容器                                        | 僅限擁有者                              | 僅限擁有者                                        |
| 建立容器                                       | 僅限擁有者                              | 僅限擁有者                                        |
| 取得容器屬性                               | 全部                                     | 僅限擁有者                                        |
| 取得容器中繼資料                                 | 全部                                     | 僅限擁有者                                        |
| 設定容器中繼資料                                 | 僅限擁有者                              | 僅限擁有者                                        |
| 取得容器 ACL                                      | 僅限擁有者                              | 僅限擁有者                                        |
| 設定容器 ACL                                      | 僅限擁有者                              | 僅限擁有者                                        |
| 刪除容器                                       | 僅限擁有者                              | 僅限擁有者                                        |
| 列出 Blob                                             | 全部                                     | 僅限擁有者                                        |
| 放置 Blob                                               | 僅限擁有者                              | 僅限擁有者                                        |
| 取得 Blob                                               | 全部                                     | 全部                                               |
| 取得 Blob 屬性                                    | 全部                                     | 全部                                               |
| 設定 Blob 屬性                                    | 僅限擁有者                              | 僅限擁有者                                        |
| 取得 Blob 中繼資料                                      | 全部                                     | 全部                                               |
| 設定 Blob 中繼資料                                      | 僅限擁有者                              | 僅限擁有者                                        |
| 放置區塊                                              | 僅限擁有者                              | 僅限擁有者                                        |
| 取得區塊清單 (僅限已認可的區塊)                 | 全部                                     | 全部                                               |
| 取得區塊清單 (僅限未認可的區塊或所有區塊) | 僅限擁有者                              | 僅限擁有者                                        |
| 放置區塊清單                                         | 僅限擁有者                              | 僅限擁有者                                        |
| 刪除 Blob                                            | 僅限擁有者                              | 僅限擁有者                                       |
| 複製 Blob                                              | 僅限擁有者                              | 僅限擁有者                                        |
| 快照 Blob                                          | 僅限擁有者                              | 僅限擁有者                                        |
