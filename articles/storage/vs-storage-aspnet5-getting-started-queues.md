...
如需詳細資訊，請參閱[如何從 .NET 使用佇列儲存體](storage-dotnet-how-to-use-queues.md/ "如何使用 .NET 的佇列儲存體") (英文)。
...
若要在程式碼中建立 Azure 佇列，而不是使用 Visual Studio 的 [**伺服器總管**]，只需將呼叫加入至 `CreateIfNotExistsAsync()`。
