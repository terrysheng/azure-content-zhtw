...
本文說明如何在您使用 Visual Studio 的 [新增連接的服務] 對話方塊建立或參考了 ASP.NET 5 專案中的 Azure 儲存體帳戶之後，開始在 Visual Studio 使用 Azure 表格儲存體。[新增連接的服務] 作業會安裝適當的 NuGet 套件，以存取專案中的 Azure 儲存體，並將儲存體帳戶的連接字串新增至您的專案設定檔。
