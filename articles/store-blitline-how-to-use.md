...
如需詳細資訊，請參閱 [][]<http://www.blitline.com></a> (英文)。

## <span id="whatisnot"></span></a>Blitline 不是什麼...
...
在有了 JSON 之後，您唯一需要做的動作是將它**發貼**至 `http://api.blitline.com/jobs`
...
透過填入您自己的大寫值，您可以將此 JSON 提交至 <http://api.blitline.com/job>，便會對 "src" 影像採用模糊濾鏡的處理，然後推送至您的 Azure 目的地。
