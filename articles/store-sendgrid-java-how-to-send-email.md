<properties urlDisplayName="SendGrid Email Service" pageTitle="如何使用 SendGrid 電子郵件服務 (Java) - Azure" metaKeywords="Azure SendGrid, Azure 電子郵件服務, Azure SendGrid Java, Azure 電子郵件 Java" description="了解如何在 Azure 使用 SendGrid 電子郵件服務傳送電子郵件。程式碼範例以 Java 撰寫。" metaCanonical="" services="" documentationCenter="Java" title="How to Send Email Using SendGrid from Java" authors="robmcm" solutions="" manager="wpickett" editor="mollybos" scriptId="" videoId="" />
...
<http://www.oracle.com/technetwork/java/javamail>，並將其匯入至
...
2.  擴充 <span class="auto-style1">javax.mail.Authenticator</span>
    類別，並在您
    <span class="auto-style1">getPasswordAuthentication</span> 方法的實作中，
...
3.  透過
    <span class="auto-style1">javax.mail.Session</span> 物件建立經過驗證的電子郵件工作階段。  

        Authenticator auth = new SMTPAuthenticator();
        Session mailSession = Session.getDefaultInstance(properties, auth);

4.  建立您的郵件，並指派 [**收件者**]、[**寄件者**]、[**主旨**] 和
內容值。如[作法：建立電子郵件](#bkmk_HowToCreateEmail)一節所示。
5.  透過
    <span class="auto-style1">javax.mail.Transport</span> 物件傳送郵件。此作業
說明餘[作法：傳送電子郵件][How to: Send an Email]
    一節中。
