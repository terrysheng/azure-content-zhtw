<properties 
    pageTitle="StorSimple 版本資訊 - 2015 年 1 月"
...
# StorSimple 版本資訊 - 2015 年 1 月

## 概觀

下列版本資訊指出 2015 年 1 月發行的 Microsoft Azure StorSimple 仍待解決的重要議題。當中也包含此版本中隨附之 StorSimple 軟體與韌體更新的清單。這是 Microsoft Azure StorSimple 公開上市 (GA) 版之後的第二個版本。
