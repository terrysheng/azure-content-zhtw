<properties 
   pageTitle="使用 StorSimple Manager 服務變更 StorSimple 密碼 |Microsoft Azure" 
...
管理入口網站的 [**設定**] 頁面包含所有裝置參數，可讓您重新設定 StorSimple Manager 服務所管理的 StorSimple 裝置。本教學課程說明如何使用 [**設定**] 頁面變更 StorSimple Snapshot Manager 或裝置系統管理員密碼。
