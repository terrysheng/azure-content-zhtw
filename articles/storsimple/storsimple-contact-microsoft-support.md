...
2. 在 [**連絡 Microsoft 支援服務**] 對話方塊中：
	...
	1. 從下拉式清單中，選取與 StorSimple Manager 服務相關聯的目標「訂用帳戶」。指定 [**支援類型**] 為 [**技術**]。您必須已付費購買支援方案，才能啟用技術支援。

	2. 按一下 [建立票證] 的核取圖示 ![核取圖示](./media/storsimple-contact-microsoft-support/IC740895.png)。
