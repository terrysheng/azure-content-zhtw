...
[**工作**] 頁面提供單一中央入口網站，針對連線到 StorSimple Manager 服務的裝置上，可供檢視和管理在裝置上啟動的工作。您可以針對多個裝置，檢視已排程、執行中、完成和失敗的工作。結果會以表格式格式呈現。
...
1. 在 [**工作**] 頁面上，透過執行查詢搭配適當的篩選器來顯示您所感興趣的工作。您可以搜尋完成、執行中或已取消工作。
...
1. 在 [**工作**] 頁面上，透過執行查詢搭配適當的篩選器來顯示您要取消的執行中工作。
