...
6. 按一下核取圖示 ![核取圖示](./media/storsimple-manage-volumes/HCS_CheckIcon.png)，即可儲存您的變更。Azure
7.  入口網站將會顯示更新磁碟區訊息。如果磁碟區已成功更新，即會顯示成功訊息。
...
![提供的影片](./media/storsimple-manage-volumes/Video_icon.png) **影片參考資訊**
