...
>[AZURE.IMPORTANT]在您開始之前，請檢閱[部署您的內部部署 StorSimple 裝置](storsimple-deployment-walkthrough.md)中的[預先安裝檢查清單](storsimple-deployment-walkthrough.md#pre-installation-checklist)和[部署必要條件](storsimple-deployment-walkthrough.md#deployment-prerequisites)。<br>
