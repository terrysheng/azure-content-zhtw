...
###部落格儲存體/資料表儲存體
1.  在 Azure 傳統入口網站中，瀏覽至 [儲存體] 擴充：![graphic1][graphic1]
...
###事件中樞
1.  在 Azure 傳統入口網站中，瀏覽至 [服務匯流排] 擴充：![graphic6][graphic6]
...
>[AZURE.NOTE]注意：您必須連接到 SQL Database 服務。為了示範整個過程，我們會借鑑 Azure 傳統入口網站的管理經驗，不過您也可以選擇使用其他類似 SQL Server Management Studio 的用戶端工具。

1.  在 Azure 傳統入口網站中，瀏覽至 [SQL Database] 擴充：![graphic14][graphic14]
...
1.  在 Azure 傳統入口網站中，瀏覽至 [串流分析] 擴充：![graphic26][graphic26]
