...
所有對  *www.contoso.com* 的要求流量現在會導向至  *contoso.trafficmanager.net*。

>[AZURE.IMPORTANT]您不能將第二層網域 (例如  *contoso.com*) 指向流量管理員網域。這是 DNS 通訊協定的限制 (不允許第二層網域名稱的 CNAME 記錄)。

## 另請參閱

[關於流量管理員的負載平衡方法](traffic-manager-load-balancing-methods.md)

[流量管理員設定工作](https://msdn.microsoft.com/library/azure/hh744830.aspx)
