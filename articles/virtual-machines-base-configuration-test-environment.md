...
- 開發和測試應用程式。
-  [模擬混合式雲端環境](virtual-networks-setup-simulated-hybrid-cloud-environment-testing.md)。
...
Azure 基本設定現在可以用於應用程式開發、測試或其他測試環境，例如[模擬混合式雲端環境](virtual-networks-setup-simulated-hybrid-cloud-environment-testing.md)。

## 其他資源

[混合式雲端測試環境](virtual-networks-setup-hybrid-cloud-environment-testing.md)
