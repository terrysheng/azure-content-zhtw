...
4. 	[系統準備工具]**** 對話方塊隨即出現。執行下列動作：
	...
	- 在 [**系統清理動作**] 中選取 [**Enter System Out-of-Box Experience (OOBE)**]，並確認已勾選 [**一般化**]。如需使用 Sysprep 的詳細資訊，請參閱[如何使用 Sysprep：簡介][] (英文)。
...
[成功擷取映像]: ./media/virtual-machines-capture-image-windows-server/CaptureSuccess.png
