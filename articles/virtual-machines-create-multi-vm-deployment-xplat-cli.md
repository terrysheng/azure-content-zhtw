<properties
   pageTitle="使用 Azure x-plat cli 建立多個 VM 的部署 | Azure"
   description="了解如何使用 Azure x-plat CLI 建立多個 VM 的部署"
...
# 使用 Azure x-plat cli 建立多個 VM 的部署

下列指令碼將示範如何在 VNET 中，使用 Azure 跨平台命令列介面 (xplat-cli)，來設定多個 VM 的多雲端服務部署。
