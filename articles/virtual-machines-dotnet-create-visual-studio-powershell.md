<properties pageTitle="使用 Visual Studio 建立 Web 專案的虛擬機器" description="建立網站的虛擬機器" services="virtual-machines" documentationCenter="" authors="ghogen" manager="douge" editor=""/>
...
<br/>
13. (選擇性) 在 [伺服器總管] 中，展開 [虛擬機器] 節點，為所建立的虛擬機器選擇節點，然後選擇 [Connect with Remote Desktop] 以連線到虛擬機器。
