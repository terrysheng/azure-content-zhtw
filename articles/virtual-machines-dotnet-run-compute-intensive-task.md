<properties pageTitle="虛擬機器上需密集運算的 .NET 工作 - Azure" description="了解如何在 Azure 虛擬機器上部署與執行需密集運算的 .NET 應用程式，並使用服務匯流排佇列來遠端監控進度。" services="virtual-machines" documentationCenter=".net" authors="" manager="wpickett" editor="mollybos"/>
