<properties 
	...
	description="提供可在 Azure 中設定 VM 可用性設定組的步驟" 
...
- [選項 2：將現有虛擬機器新增至可用性設定組](#addmachine)。
...
4. 使用前兩個畫面來挑選映像、使用者名稱和密碼等。如需詳細資訊，請參閱[建立執行 Windows Server 的虛擬機器](../virtual-machines-windows-tutorial)。
