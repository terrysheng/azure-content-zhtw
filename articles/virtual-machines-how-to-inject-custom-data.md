...
## <span id="usingCustomData"></span></a>在虛擬機器中使用自訂資料
...
[Microsoft Azure 跨平台命令列介面 (英文)][Microsoft Azure 跨平台命令列介面]
  ...
  [這篇 Azure 部落格文章]: http://azure.microsoft.com/blog/2014/04/21/custom-data-and-cloud-init-on-windows-azure/
  ...
  [Ubuntu 的 cloud-init 文件]: https://help.ubuntu.com/community/CloudInit
