<properties pageTitle="在執行 Windows Server 的虛擬機器上安裝 MongoDB" description="了解如何在執行 Windows Server 的 Azure VM 上安裝 MongoDB。." services="virtual-machines" documentationCenter="" authors="KBDAzure" manager="timlt" editor="tysonn"/>
...
如需初始化磁碟的指示，請參閱「做法：在 Windows Server 中初始化新的資料磁碟〉(於[如何將資料磁碟附加至 Windows 虛擬機器](http://azure.microsoft.com/zh-tw/documentation/articles/storage-windows-attach-disk/)中)。
