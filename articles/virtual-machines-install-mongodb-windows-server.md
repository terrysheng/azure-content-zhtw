...
如需初始化磁碟的指示，請參閱[如何將資料磁碟附加至 Windows 虛擬機器](http://azure.microsoft.com/zh-tw/documentation/articles/storage-windows-attach-disk/)中的「在 Windows 伺服器中初始化新的資料磁碟」。
