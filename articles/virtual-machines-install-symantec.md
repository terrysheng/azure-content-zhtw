<properties pageTitle="如何在 Azure VM 上安裝和設定 Symantec Endpoint Protection" description="說明如何在 Azure 的 VM 上安裝和設定 Symantec Endpoint Protection" services="virtual-machines" documentationCenter="" authors="KBDAzure" manager="timlt" editor=""/>
