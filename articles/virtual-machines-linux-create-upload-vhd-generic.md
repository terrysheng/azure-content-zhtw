<properties pageTitle="在 Azure 中建立及上傳 Linux VHD" description="了解如何建立及上傳包含 Linux 作業系統的 Azure 虛擬硬碟 (VHD)。" services="virtual-machines" documentationCenter="" authors="szarkos" manager="timlt" editor="tysonn"/>
...
若要解決此問題，您可以使用 [Hyper-V 管理員主控台] 或 [Resize-VHD](http://technet.microsoft.com/zh-tw/library/hh848535.aspx) Powershell Cmdlet 來調整 VM 大小。
