...
## <span id="superuserprivileges"></span></a>取得超級使用者權限，方法是使用 `sudo`
...
## <span id="hostnamechanges"></span></a>主機名稱變更
...
-   另請參閱：[在 Linux 上設定軟體 RAID][]
  ...
  [連接磁碟]: #attachingdisks
  [如何對 Azure 上的 Linux 使用 SSH]: ../linux-use-ssh-key/
  [在 Azure 中的 Linux 虛擬機器上使用根權限]: ../virtual-machines-linux-use-root-privileges/
  [如何設定虛擬機器的端點]: ../virtual-machines-set-up-endpoints/
  ...
  [如何擷取 Linux 虛擬機器作為範本使用]: ../virtual-machines-linux-capture-image/
  [如何將資料磁碟附加至虛擬機器]: ../virtual-machines-linux-how-to-attach-disk/
