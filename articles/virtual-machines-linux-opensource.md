...
- [做法：上傳您自己的 Distro 映像](http://azure.microsoft.com/documentation/articles/virtual-machines-linux-create-upload-vhd/) (以及使用 [Azure 背書散發版本](http://azure.microsoft.com/documentation/articles/virtual-machines-linux-endorsed-distributions/)的指示)
...
1. [做法：上傳您自己的 Ubuntu 映像](http://azure.microsoft.com/documentation/articles/virtual-machines-linux-create-upload-vhd-ubuntu/)
2. [做法：Ubuntu LAMP 堆疊](http://azure.microsoft.com/documentation/articles/virtual-machines-linux-install-lamp-stack/)
2. [映像：LAPP 堆疊](http://azure.microsoft.com/marketplace/partners/bitnami/lappstack54310ubuntu1404/)
3. [做法：MySQL 叢集](http://azure.microsoft.com/documentation/articles/virtual-machines-linux-mysql-cluster/)
4. [做法：Node.js 和 Cassandra](http://azure.microsoft.com/documentation/articles/virtual-machines-linux-nodejs-running-cassandra/)
5. [做法：IPython Notebook](http://azure.microsoft.com/documentation/articles/virtual-machines-python-ipython-notebook/)
...
3. [做法：針對 Azure 準備自訂 CentOS 型 VM](http://azure.microsoft.com/documentation/articles/virtual-machines-linux-create-upload-vhd-centos/)
...
12. [做法：準備自訂 SLES 或 openSUSE VM](http://azure.microsoft.com/documentation/articles/virtual-machines-linux-create-upload-vhd-suse/)  
...
14. [Github：在 Azure 上部署 CoreOS 的快速入門](https://github.com/timfpark/coreos-azure)
...
5. [基本概念：選取 Linux 使用者名稱](http://azure.microsoft.com/documentation/articles/virtual-machines-linux-usernames/)
6. [基本概念：使用 Azure 入口網站登入 Linux VM](http://azure.microsoft.com/documentation/articles/virtual-machines-linux-how-to-log-on/)
...
10. [基本概念：將資料磁碟連接至 Linux VM](http://azure.microsoft.com/documentation/articles/virtual-machines-linux-how-to-attach-disk/)
11. [基本概念：從 Linux VM 卸離資料磁碟](http://azure.microsoft.com/documentation/articles/virtual-machines-linux-how-to-detach-disk/)
...
13. [基本概念：RAID](http://azure.microsoft.com/documentation/articles/virtual-machines-linux-configure-raid/)
14. [基本概念：擷取 Linux VM 來製作範本](http://azure.microsoft.com/documentation/articles/virtual-machines-linux-capture-image/)
15. [基本概念：Azure Linux 代理程式](http://azure.microsoft.com/documentation/articles/virtual-machines-linux-agent-user-guide/)
...
3. [做法：使用 Azure 入口網站在 Linux 上設定 Tomcat7](http://azure.microsoft.com/documentation/articles/virtual-machines-linux-setup-tomcat7-linux/)
...
3. Deis
	- [GitHub 儲存機制︰
在 Azure 的 CoreOS 叢集上安裝 Deis](https://github.com/chanezon/azure-linux/tree/master/coreos/deis)
4. Kubernetes
...
10. Chef
	- [Chef 和虛擬機器](http://azure.microsoft.com/documentation/articles/virtual-machines-windows-install-chef-client/)
