<properties pageTitle="Azure Linux Vm 上的 MySQL 效能最佳化" description="了解如何最佳化在執行 Linux 的 Azure 虛擬機器 (VM) 上執行的 MySQL。" services="virtual-machines" documentationCenter="" authors="NingKuang" manager="timlt" editor="tysonn"/>
...
[http://azure.microsoft.com/zh-tw/documentation/articles/virtual-machines-linux-configure-RAID/](http://azure.microsoft.com/zh-tw/documentation/articles/virtual-machines-linux-configure-RAID/)
