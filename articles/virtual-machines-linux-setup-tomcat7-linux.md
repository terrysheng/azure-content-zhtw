<properties pageTitle="如何透過 Microsoft Azure 在 Linux 虛擬機器上設定 Tomcat7" description="學習如何透過 Microsoft Azure 使用執行 Linux 的 Azure 虛擬機器 (VM) 設定 Tomcat7。" services="virtual-machines" documentationCenter="" authors="NingKuang" manager="timlt" editor="tysonn"/>
