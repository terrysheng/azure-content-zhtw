<properties urlDisplayName="Use root privileges" pageTitle="在 Azure 中的 Linux 虛擬機器上使用根權限" metaKeywords="" description="了解如何在 Azure 中的 Linux 虛擬機器上使用根權限。" metaCanonical="" services="virtual-machines" documentationCenter="" title="Using root privileges on Linux virtual machines in Azure" authors="szarkos" solutions="" manager="timlt" editor="" />
