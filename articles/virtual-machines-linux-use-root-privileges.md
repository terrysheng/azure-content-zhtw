<properties pageTitle="在 Azure 中的 Linux 虛擬機器上使用 root 權限" description="了解如何在 Azure 中的 Linux 虛擬機器上使用 root 權限。" services="virtual-machines" documentationCenter="" authors="szarkos" manager="timlt" editor=""/>
