<properties 
	pageTitle="如何針對 Linux 虛擬機器使用 VMAccess" 
	description="如何針對 Linux 使用 VMAccess，以重設密碼、SSH 金鑰與 SSH 設定" 
...
[使用 RDP 或 SSH 連線到 Azure 虛擬機器]: http://msdn.microsoft.com/library/azure/dn535788.aspx
