<properties urlDisplayName="Load Balancing for Azure Infrastructure Services" pageTitle="Azure 基礎結構服務的負載平衡" metaKeywords="load balancer, Traffic manager" description="說明 Azure 支援的兩種不同負載平衡類型：適用於雲端服務的負載平衡器和適用於用戶端流量的 Azure 流量管理員。" metaCanonical="http://www.windowsazure.com/zh-tw/manage/windows/common-tasks/how-to-load-balance-virtual-machines/" services="virtual-machines" documentationCenter="" title="" authors="josephd" solutions="" manager="timlt" editor="" />
