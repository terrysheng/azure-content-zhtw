...
4. 在第一個 [虛擬機器組態] 頁面，請提供下列資訊：
    ...
    > 當您使用 SQL Server Enterprise Edition 時，請選取 A3 或以上的大小。
   	...
   	> 選取的大小會限制可設定的資料磁碟數目。如需可用之虛擬機器大小和可連接至虛擬機器之資料磁碟數目的最新資訊，請參閱 [Azure 的虛擬機器大小](http://msdn.microsoft.com/library/azure/dn197896.aspx)。
