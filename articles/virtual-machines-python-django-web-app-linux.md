...
1. 按照 [此處][portal-vm] 提供的指示建立 *Ubuntu Server 14.04 LTS* 散發套件的 Azure 虛擬機器。

  **注意：**您*only*需要建立虛擬機器。在進行到標題為*How to log on to the virtual machine after you create it*一節時停止。
