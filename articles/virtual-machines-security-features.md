<properties pageTitle="Azure 虛擬機器的安全性產品" description="Azure VM 重要安全性功能的快速概觀及詳細資料的連結" services="virtual-machines" documentationCenter="" authors="KBDAzure" manager="timlt" editor=""/>
...
- [如何在 Azure VM 上安裝和設定 Trend Micro Deep Security 為服務](http://go.microsoft.com/fwlink/p/?LinkId=404206)
...
## 其他資源
Microsoft Azure 信任中心上的[資源](http://azure.microsoft.com/zh-tw/support/trust-center/resources/)
