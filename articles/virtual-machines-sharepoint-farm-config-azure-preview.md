<properties title="SharePoint Server 伺服器陣列組態詳細資料" pageTitle="SharePoint Server 伺服器陣列組態詳細資料" description="說明 SharePoint 伺服器陣列的預設組態" metaKeywords="" services="virtual-machines" solutions="" documentationCenter="" authors="josephd" videoId="" scriptId="" manager="timlt"/>
