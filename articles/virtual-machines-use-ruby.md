<properties pageTitle="什麼是 Azure Multi-Factor Authentication？" description="深入了解 Azure Multi-Factor Authentication，Multi-Factor Authentication 是需要使用多種驗證方法，並在使用者登入和交易中新增重要第二安全性階層的驗證方法。" services="active-directory, multi-factor-authentication" documentationCenter="" authors="blackmist" manager="wpickett" editor=""/>
