<properties pageTitle="關於 Puppet 和 Azure 虛擬機器" description="說明如何在 Azure VM 上安裝和設定 Puppet" services="virtual-machines" documentationCenter="" authors="KBDAzure" manager="timlt" editor=""/>
