...
請使用這個範本，快速設計出色的作品。除了這些範本之外，您也可以透過 [Azure 快速入門範本](https://azure.microsoft.com/documentation/templates/)進行搜尋。
