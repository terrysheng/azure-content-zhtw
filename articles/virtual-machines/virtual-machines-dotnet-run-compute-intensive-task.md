...
1.  在左方導覽窗格中，按一下 [服務匯流排]，以顯示可用的命名空間清單。![Available namespaces screenshot][available_namespaces]
...
3. 加入 System Runtime Serialization 程式庫。在 Visual Studio 方案總管中，以滑鼠右鍵按一下 [TSPClient]，按一下 [加入參考] 及 [.NET] 索引標籤，然後選取 **System.Runtime.Serialization** 做為參考。
