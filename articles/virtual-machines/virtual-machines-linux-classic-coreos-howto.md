...
使用[如何對 Azure 上的 Linux 使用 SSH](virtual-machines-linux-ssh-from-linux.md)中的指示，建立 SSH 的公開和私密金鑰。(您可在下面的指示中找到基本步驟。) 您打算使用這些金鑰來與叢集中的 VM 連線，以驗證他們是否可正常運作並可互相通訊。
...
[YAML]: http://yaml.org/
[開始在 Azure 上的 CoreOS 使用 Fleet]: virtual-machines-linux-classic-coreos-fleet-get-started.md
