...
## 可以使用 RHUI 的區域
RHUI 可用於 [Azure 狀態儀表板](https://azure.microsoft.com/status/)中列出的所有公用區域。這表示在這些區域您可以取得 yum 更新服務而不需要任何額外費用。這些資訊未來將會更新。

## 從其他更新儲存機制 (如 Red Hat Network Satellite) 取得更新

若要從其他更新儲存機制取得更新，您需要有 Red Hat Cloud Access 授權，以及現有的 Azure Red Hat 訂用帳戶。

接下來，您需要取消註冊 RHUI 並向您的更新基礎結構註冊。以下是詳細的步驟。
