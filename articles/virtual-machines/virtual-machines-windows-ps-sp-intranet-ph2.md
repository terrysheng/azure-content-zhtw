...
您必須先完成這個階段才能前往[第 3 階段](virtual-machines-windows-ps-sp-intranet-ph3.md)。如需所有階段的詳細資訊，請參閱[在 Azure 中使用 SQL Server AlwaysOn 可用性群組部署 SharePoint](virtual-machines-windows-sp-intranet-overview.md)。
...
回想您在[第 1 階段：設定 Azure](virtual-machines-windows-ps-sp-intranet-ph1.md) 中所定義的資料表 V、S、ST 和 A。
...
- 依照[第 3 階段](virtual-machines-windows-ps-sp-intranet-ph3.md)指示繼續此工作負載的設定。
