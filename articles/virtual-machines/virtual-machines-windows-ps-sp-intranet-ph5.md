...
如需所有階段的詳細資訊，請參閱[在 Azure 中使用 SQL Server AlwaysOn 可用性群組部署 SharePoint](virtual-machines-windows-sp-intranet-overview.md)。
...
1.	以 **[網域]\\sp\_farm\_db** 登入主要 SQL Server 主機。
2.	導覽至 F:\\ 磁碟。
...
1.	以 **[網域名稱]\\sp\_farm\_db** 登入次要 SOL Server 電腦。
