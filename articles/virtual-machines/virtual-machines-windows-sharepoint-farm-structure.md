...
您也可以使用 Azure 資源管理員範本。請參閱 [SharePoint](virtual-machines-linux-app-frameworks.md)。
...
您也可以使用 Azure 資源管理員範本。請參閱[部署一個包含九部伺服器的 SharePoint 伺服器陣列](virtual-machines-windows-app-frameworks.md#deploy-a-nine-server-sharepoint-farm)。
