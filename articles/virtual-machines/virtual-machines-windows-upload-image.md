...
本文說明如何使用 Windows 作業系統上傳虛擬硬碟 (VHD)，讓您可以使用它來透過資源管理員部署模型建立新的 Windows 虛擬機器。如需 Microsoft Azure 中磁碟和 VHD 的詳細資訊，請參閱[關於虛擬機器的磁碟和 VHD](virtual-machines-linux-about-disks-vhds.md)。
