...
如果您想要建立純雲端虛擬網路，請參閱[教學課程：在 Azure 中建立純雲端虛擬網路](create-virtual-network.md)。如果您想要使用憑證和 VPN 用戶端來建立點對網站 VPN，請參閱[使用管理入口網站精靈設定點對站 VPN](http://go.microsoft.com/fwlink/p/?LinkId=296653)。
...
-  [將虛擬機器新增至虛擬網路](virtual-machines-create-custom.md)
