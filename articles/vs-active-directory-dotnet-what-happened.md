<properties title="開始使用 Active Directory 驗證 - 發生什麼情形" pageTitle="開始使用 Active Directory 驗證 - 發生什麼情形" metaKeywords="Azure, Getting Started, Active Directory" description="" services="active-directory" documentationCenter="" authors="ghogen, kempb" />
