...
- 您可以在開發時從 Visual Studio 進行 Azure 應用程式偵錯，就如同任何 Visual C# 或 Visual Basic 應用程式一樣。如需詳細資訊，請參閱[在 Visual Studio 中進行雲端服務或虛擬機器偵錯](http://go.microsoft.com/fwlink/p/?LinkID=623018)。
