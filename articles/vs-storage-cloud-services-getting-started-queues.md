...
<div class="dev-center-tutorial-selector sublanding"><a href="/en-us/documentation/articles/vs-storage-cloud-services-getting-started-blobs" title="Blob" class="current">Blob</a><a href="/en-us/documentation/articles/vs-storage-cloud-services-getting-started-queues" title="佇列">佇列</a><a href="/en-us/documentation/articles/vs-storage-cloud-services-getting-started-tables" title="資料表">資料表</a></div>
...
若要在雲端服務專案中以程式設計方式存取佇列，您需要執行下列工作。
...
[WACOM.INCLUDE [vs-storage-getting-started-queues-include][vs-storage-getting-started-queues-include]]
  ...
  [佇列]: /en-us/documentation/articles/vs-storage-cloud-services-getting-started-queues "佇列"
  [資料表]: /en-us/documentation/articles/vs-storage-cloud-services-getting-started-tables "資料表"
  [如何從 .NET 使用佇列儲存體]: http://azure.microsoft.com/en-us/documentation/articles/storage-dotnet-how-to-use-queues/ "如何從 .NET 使用佇列儲存體"
