<properties 
	pageTitle="在 Azure 網站中驗證和授權企業營運應用程式" 
	description="了解部署至 Azure 網站之企業營運應用程式的不同驗證和授權選項" 
	services="web-sites" 
	documentationCenter="" 
	authors="cephalin" 
	manager="wpickett" 
...
只要按幾下按鈕，就能啟用網站的驗證和授權機制。每個 Azure 網站中的核取方塊樣式均提供 LOB 網站的基本存取控制。它是在授與使用者所有網站內容的存取權之前，藉由對您選擇的 Azure 租用戶強制 HTTPS 和驗證，以達到存取控制的目的。如需詳細資訊，請參閱 [Azure 網站驗證/授權](http://azure.microsoft.com/blog/2014/11/13/azure-websites-authentication-authorization/)。
