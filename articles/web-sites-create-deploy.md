<properties 
	pageTitle="如何建立網站 - Azure 服務管理" 
	description="了解如何使用 Azure Management Portal 建立網站。" 
	services="web-sites" 
	documentationCenter="" 
	authors="cephalin" 
	manager="wpickett" 
...
如需關於如何將內容部署到已建立之 Azure 網站的詳細資訊，請參閱 [Azure 網站](/zh-tw/documentation/services/web-sites/).中的　**＜部署＞**一節
...
7. **[設定]** 管理頁面會公開您的網站設定，例如：
	...
	- 自訂網域名稱
	- 記錄選項
	- Azure 環境的應用程式設定 (例如， <appSettings> 在您開發環境的 Web.config 中覆寫)
	- 連接字串 (例如， <connectionStrings> 在您開發環境的 Web.config 中覆寫)
	- 特定副檔名的指令碼處理器，例如 *.php
