<properties 
	pageTitle="使用流量管理員設定 Azure 網站的 DomainDiscover 網域名稱" 
	description="了解如何設定使用 Traffic Manager 的 Azure 網站使用向 DomainDiscover - TierraNet 註冊的網域名稱" 
	services="web-sites" 
	documentationCenter="" 
	authors="blackmist" 
	manager="wpickett" 
...
5. 在下列頁面上，輸入 DNS 記錄值。然後按一下 **[新增]** 按鈕。
    ...
    ![DNS 編輯按鈕](.\media\web-sites-domaindiscover-custom-domain-name\DomainDiscover_DNSRecords_TM.png)
