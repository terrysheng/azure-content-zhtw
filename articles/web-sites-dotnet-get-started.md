...
7. 按一下 [變更驗證]****。
	...
	![[New ASP.NET Project] 對話方塊](./media/web-sites-dotnet-get-started-vs2013/GS13changeauth.png)
...
5. 在 [新增 ASP.NET 專案]**** 對話方塊中，保留 [MicrosoftAzure]**** 下的設定，然後按一下 [確定]****。
	...
	![[New ASP.NET Project] 對話方塊](./media/web-sites-dotnet-get-started-vs2013/GS13newaspnetprojdb.png)
...
6. 按一下 [確定]****。
	...
	![已登入 Azure](./media/web-sites-dotnet-get-started-vs2013/configuresitesettings2.png)
	...
	![已建立 Web 應用程式](./media/web-sites-dotnet-get-started-vs2013/GS13sitecreated1.png)

	因此，您可以在 [伺服器總管] 中檢視該 Web 應用程式。

	![已建立 Web 應用程式](./media/web-sites-dotnet-get-started-vs2013/siteinse.png)

## 將應用程式部署至 Azure

7. 在 [Azure App Service 活動]**** 視窗中，按一下 [立即將 MyExample 發行至這個 Web 應用程式]****。

	![已建立 Web 應用程式](./media/web-sites-dotnet-get-started-vs2013/GS13sitecreated.png)
...
10. 在 [設定]**** 索引標籤中，按 [下一步]****。
	...
	![[設定] 索引標籤](./media/web-sites-dotnet-get-started-vs2013/GS13SettingsTab.png)
...
11. 在 [預覽]**** 索引標籤中，按一下 [開始預覽]****。
	...
	![[預覽] 索引標籤中的 [開始預覽] 按鈕](./media/web-sites-dotnet-get-started-vs2013/GS13Preview.png)
...
12. 按一下 [發行]****。
	...
	![在 Azure 中執行的 Web 應用程式](./media/web-sites-dotnet-get-started-vs2013/GS13deployedsite.png)
...
2. 在 [方案總管]** 中開啟 *Views/Home/Index.cshtml* 或 **.vbhtml** 檔案，將 **h1** 標題從 "ASP.NET" 變更為 "ASP.NET and Azure"，並儲存檔案。 
	...
	![MVC h1 變更](./media/web-sites-dotnet-get-started-vs2013/mvcandazure.png)

1. 在本機電腦上執行 Web 應用程式，然後按 CTRL+F5 檢視更新的標題。

	![本機執行的 Web 應用程式](./media/web-sites-dotnet-get-started-vs2013/localandazure.png)
...
2. 在 [發行 Web]**** 精靈中，按一下 [發行]****。
	...
	![已部署變更的 Web 應用程式](./media/web-sites-dotnet-get-started-vs2013/deployedandazure.png)

**提示：**您可以啟用 [Web 單鍵發行]**** 工具列，以加快部署速度。按一下 [檢視]**** > [工具列]****，然後選取 [Web 單鍵發行]****。此工具列可讓您選取設定檔，按一下按鈕進行發行，或按一下按鈕以開啟 [發行 Web]**** 精靈。

![Web 單鍵發行工具列](./media/web-sites-dotnet-get-started-vs2013/weboneclickpublish.png)
...
1. 在瀏覽器中，移至 [http://portal.azure.com]()，然後以您的 Azure 認證登入。

2. 按一下 [瀏覽] > **[Web Apps]**，然後按一下 Web 應用程式的名稱。

	Web 應用程式{b>的 <b}[Web 應用程式]**** 刀鋒視窗會顯示常用 Web 應用程式管理功能的使用量統計資料和連結。
  
	![Web 應用程式刀鋒視窗](./media/web-sites-dotnet-get-started-vs2013/portaldashboard.png)-->
...
4. 按一下 [應用程式設定]****，以查看您可以在入口網站中設定的設定種類範例。
	...
	![入口網站 Web 應用程式設定索引標籤](./media/web-sites-dotnet-get-started-vs2013/portalconfigure2.png)
...
* [如何選擇或建立 App Service 方案](azure-web-sites-web-hosting-plans-in-depth-overview.md)
