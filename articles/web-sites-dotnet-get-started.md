...
4. 按一下 [設定]**** 索引標籤。
	...
	[[設定](/zh-tw/documentation/articles/web-sites-configure//)] 索引標籤可讓您控制用於網站的 .NET 版本、啟用 [WebSockets](/blog/2013/11/14/introduction-to-websockets-on-windows-azure-web-sites/) 和[診斷記錄](/zh-tw/documentation/articles/web-sites-enable-diagnostic-log/)等功能，以及設定 [connection string values](/blog/2013/07/17/windows-azure-web-sites-how-application-strings-and-connection-strings-work/) 等等。 

	![Portal web site configure tab](./media/web-sites-dotnet-get-started-vs2013/portalconfigure.png)
  
5. 按一下 [調整]**** 索引標籤。

	針對網站服務的付費層，[[調整](/zh-tw/documentation/articles/web-sites-scale/)] 索引標籤可讓您控制為您的 Web 應用程式提供服務之機器的大小和數量，以因應流量的變動。
