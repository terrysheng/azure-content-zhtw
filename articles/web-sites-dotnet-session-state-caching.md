...
快取服務 (預覽) 在網站外部提供了分散式快取服務。此舉可解決處理序內的工作階段狀態問題。如需如何使用工作階段狀態的詳細資訊，請參閱 [ASP.NET 工作階段狀態概觀](http://msdn.microsoft.com/en-us/library/ms178581.aspx)。
...
如需如何使用 ASP.NET 工作階段狀態的詳細資訊，請參閱 [ASP.NET 工作階段狀態概觀](http://msdn.microsoft.com/en-us/library/ms178581.aspx)。
