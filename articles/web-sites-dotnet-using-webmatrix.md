...
3.  如果您已登入 Azure，則現在可選擇建立 Azure 網站做為您的本機網站。請選擇唯一名稱，並選取您想在其中建立網站的資料中心。
...
7.  檢查電子郵件，確定您收到訂單確認。如果您無法傳送電子郵件，請參閱＜ASP.NET 網頁 (Razor) 疑難排解指南＞中的＜[傳送電子郵件時的問題](http://go.microsoft.com/fwlink/?LinkId=253001#email)＞(英文)。
