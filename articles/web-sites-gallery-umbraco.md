...
3.  在 [映像庫] 中，選取 [Web] 索引標籤，然後選取 [Umbraco CMS]。
    ...
    ![Select Umbraco in the Web Gallery][]
...
[Microsoft Azure 預覽入口網站文件][]

[Azure 預覽入口網站 (第 9 頻道)][]

[Microsoft Azure 網站文件][]
...
<!-- IMAGES -->
  ...
  [Microsoft Azure 預覽入口網站概觀]: http://azure.microsoft.com/en-us/overview/preview-portal/
