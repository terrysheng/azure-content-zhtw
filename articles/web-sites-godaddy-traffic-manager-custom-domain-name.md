...
使用流量管理員來設定 Azure 網站的自訂網域名稱 (GoDaddy)
=======================================================
...
[網站](/zh-tw/documentation/articles/web-sites-godaddy-custom-domain-name/ "網站") | [使用流量管理員的網站](/zh-tw/documentation/articles/web-sites-godaddy-traffic-manager-custom-domain-name/ "使用流量管理員的網站")
