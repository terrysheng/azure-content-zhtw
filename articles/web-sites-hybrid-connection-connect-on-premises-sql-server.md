<properties 
	pageTitle="混合式連線逐步說明：從 Azure 網站連接至內部部署 SQL Server" 
	description="在 Microsoft Azure 上建立網站，並將它連接到內部部署 SQL Server 資料庫" 
	services="web-sites" 
	documentationCenter="" 
	authors="cephalin" 
	manager="wpickett" 
...
> [AZURE.NOTE] 如果您已在 Azure 預覽入口網站中建立本教學課程要使用的網站，則您可以直接跳到[建立混合式連線和 BizTalk 服務](#CreateHC) 繼續作業。
