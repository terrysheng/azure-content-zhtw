...
當您依照[開始使用 Microsoft Azure 網站和 Java][] 所述初始化網站之後，就可以將 WAR 放在 **webapps** 資料夾中以便上傳您的應用程式。
...
請注意，您可以使用原始檔控制來上傳應用程式或網頁，這會納入連續整合案例。如需在網站中使用原始檔控制的指示，請參閱[從原始檔控制發佈至 Azure 網站][]。FTP 也是一個可上傳應用程或網頁的選項。
