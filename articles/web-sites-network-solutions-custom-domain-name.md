...
<div class="dev-center-tutorial-subselector"><a href="/zh-TW/documentation/articles/web-sites-network-solutions-custom-domain-name/" title="網站" class="current">網站</a> | <a href="/zh-TW/documentation/articles/web-sites-network-solutions-traffic-manager-custom-domain-name/" title="使用流量管理員的網站">使用流量管理員的網站</a></div>

[WACOM.INCLUDE [websites-cloud-services-css-guided-walkthrough](../includes/websites-cloud-services-css-guided-walkthrough.md)]

[WACOM.INCLUDE [intro](../includes/custom-dns-web-site-intro.md)]

本文提供使用 Azure 網站，從 [Network Solutions][Network Solutions] 購買的自訂網域名稱的使用指示。
...
2.  在 [我的產品和服務] 索引標籤中，選取 [編輯 DNS]。
    ...
    ![edit dns page][edit dns page]

3.  從 [網域名稱] 頁面的 [管理 <yourdomainname>] 區段中，選取 [編輯進階 DNS 記錄]。

    ![domain names page with edit advanced dns records highlighted][domain names page with edit advanced dns records highlighted]
...
4.  [更新進階 DNS] 頁面包含每個記錄類型的區段，每個區段底下都有 [編輯] 按鈕。
    ...
    ![update advanced dns page][update advanced dns page]
