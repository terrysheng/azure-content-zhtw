...
[網站](/en-us/documentation/articles/web-sites-network-solutions-custom-domain-name/ "網站") | [使用流量管理員的網站](/en-us/documentation/articles/web-sites-network-solutions-traffic-manager-custom-domain-name/ "使用流量管理員的網站")
...
若要將您的自訂網域與 Azure 網站建立關聯，必須使用 Network Solutions 提供的工具，在 DNS 資料表中為您的自訂網域新增項目。使用下列步驟來尋找並使用 DNS 工具。
