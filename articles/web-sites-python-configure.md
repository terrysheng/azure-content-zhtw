...
[http://azure.microsoft.com/zh-tw/documentation/articles/web-sites-python-create-deploy-django-app/?fb=zh-tw](http://azure.microsoft.com/zh-tw/documentation/articles/web-sites-python-create-deploy-django-app/?fb=zh-tw)。
...
本教學課程假定現有一個 Azure 訂閱，而且能夠存取 Azure 管理入口網站。以下網站提供您建立網站的詳細說明：[][1][http://azure.microsoft.com/zh-tw/documentation/articles/web-sites-create-deploy/?fb=zh-tw][1]</a>。
...
![][5]
  ...
  [0]: http://www.windowsazure.com/zh-TW/develop/python/tutorials/web-sites-with-django
