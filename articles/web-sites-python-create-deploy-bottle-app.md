...
針對 Git，建議您安裝 [Git for Windows](http://msysgit.github.io/) 或 [GitHub for Windows](https://windows.github.com/)。如果您使用 Visual Studio，您可以使用整合式的 Git 支援。
...
<!--Link references-->
[Azure 上採用 Python Tools 2.1 for Visual Studio的 Bottle 和 MongoDB]: ../web-sites-python-ptvs-bottle-table-storage
[Azure 上採用 Python Tools 2.1 for Visual Studio 的 Bottle 和 Azure 資料表儲存體]: ../web-sites-python-ptvs-bottle-mongodb
