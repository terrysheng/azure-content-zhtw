<properties pageTitle="什麼是 Web 主控方案？" description="Web hosting plan overview" title="What is a web hosting plan?" services="web-sites" authors="adamab" manager="wpickett" />
...
[深入瞭解 Web 主控方案的管理](http://go.microsoft.com/fwlink/?LinkID=394411) (英文)。
...
按一下方案將啟動刀鋒，您可使用刀鋒來管理 Web 主控方案。[深入瞭解 Web 主控方案的管理](http://go.microsoft.com/fwlink/?LinkID=394411) (英文)。
