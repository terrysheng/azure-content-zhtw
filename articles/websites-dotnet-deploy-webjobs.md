<properties urlDisplayName="Deploy Azure WebJobs to Azure Websites" pageTitle="將 Azure WebJobs 部署至 Azure 網站 " metaKeywords="Azure 網站, WebJobs, 背景工作" description="了解如何使用 Visual Studio 將 Azure WebJobs 部署到 Azure 網站。" metaCanonical="" services="web-sites" documentationCenter="" title="Deploy Azure WebJobs to Azure Websites" authors="tdykstra"  solutions="" manager="wpickett" editor="mollybos" />
