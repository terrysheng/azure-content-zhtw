...
本指南提供 C# 程式碼範例，示範如何在建立或更新 Azure Blob 時觸發程序。此程式碼範例使用 [WebJobs SDK](../websites-dotnet-webjobs-sdk/) 1.x 版。

本指南假設您知道[如何使用指向您儲存體帳戶的連接字串，在 Visual Studio 中建立 WebJob 專案](../websites-dotnet-webjobs-sdk-get-started/)。
...
如需與特定服務匯流排無關的 WebJobs SDK 案例的相關資訊，請參閱[如何使用 Azure 佇列儲存體與 WebJobs SDK](../websites-dotnet-webjobs-sdk-storage-queues-how-to/)。 
