...
[Visual Studio Application Insights](../article/application-insights/app-insights-overview.md) 監視您的即時應用程式，協助您[偵測並診斷效能問題和例外狀況](../article/application-insights/app-insights-detect-triage-diagnose.md)，同時[探索應用程式的使用情況](../article/application-insights/app-insights-overview-usage.md)。
