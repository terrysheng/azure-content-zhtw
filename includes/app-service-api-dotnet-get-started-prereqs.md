...
此教學課程假設您基本上已了解如何在 Visual Studio 中使用 ASP.NET [Web API 2](http://www.asp.net/web-api/overview/getting-started-with-aspnet-web-api/tutorial-your-first-web-api) 和 [MVC 5](http://www.asp.net/mvc/overview/getting-started/introduction/getting-started)。
