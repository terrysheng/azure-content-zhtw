...
* [如何設定企業級的 WordPress Web 應用程式](web-sites-php-enterprise-wordpress.md)
...
* [如何備份 Web 應用程式](web-sites-backup.md)和[如何還原 Web 應用程式](web-sites-restore.md)。
...
* 如何使用 [Redis 快取外掛程式](https://wordpress.org/plugins/wp-redis/)來[啟用 Redis 快取](../redis-cache/cache-dotnet-how-to-use-azure-redis-cache.md)
* 如何使用 [Memcached 外掛程式](https://wordpress.org/plugins/memcached/)來[啟用 WordPress 的 Memcached 物件快取](web-sites-connect-to-redis-using-memcache-protocol.md)
