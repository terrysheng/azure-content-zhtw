將驗證新增至行動應用程式：[iOS][ios-get-started-users]、[Xamarin.iOS][xamarin-ios-get-started-users]、[Xamarin.Android][xamarin-android-get-started-users]、[Windows Universal][windows-get-started-users]。
