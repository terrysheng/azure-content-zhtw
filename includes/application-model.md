...
有兩個輸入端點：在通訊埠 80 上接聽的 HTTP 以及在通訊埠 443 上
接聽的 HTTPS。下圖顯示的範例有兩個不同的角色，
...
基本上會保留 *前置詞*.cloudapp.net URL，讓其他人都無法
