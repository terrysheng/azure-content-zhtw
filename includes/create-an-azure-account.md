...
2.  如果您有 MSDN 訂閱，請瀏覽到 [MSDN 訂戶的 Azure 權益][MSDN 訂戶的 Azure 權益]頁面，並依照步驟啟用 MSDN 訂戶的權益來建立帳戶。

否則，請瀏覽到[建立免費試用帳戶][建立免費試用帳戶]頁面，並依照步驟來建立試用帳戶。您將需要有信用卡號和行動電話號碼來證明身分，但是您不會被收取任何費用。
