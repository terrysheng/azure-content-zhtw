...
6. 或者，您可以選取帳戶所需的複寫類型。地理區域備援複寫是預設值，而且提供最高的持久性。如需複寫選項的詳細資訊，請參閱 [Azure 儲存體備援選項](http://msdn.microsoft.com/zh-tw/library/azure/dn727290.aspx)和 [Azure 儲存體團隊部落格](http://blogs.msdn.com/b/windowsazurestorage/)。
