...
本指南說明如何使用適用於 Mac 和 Linux 的 Azure 命令列工具，在 Azure 中建立和管理服務。涵蓋的案例包括**安裝工具**、**匯入發行設定**、**建立和管理 Azure 網站**和**建立和管理 Azure 虛擬機器**。如需完整的參考文件，請參閱＜[適用於 Mac 和 Linux 的 Azure 命令列工具文件][1]＞。
