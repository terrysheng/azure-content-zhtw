...
> [AZURE.NOTE] 可能需要一些時間，上述步驟建立的 CNAME 記錄才能傳播至整個 DNS 系統。完成 CNAME 傳播前，您無法將網域名稱新增至 Azure 網站。如果您正在使用 A 記錄，則在傳播上個步驟建立的 **awverify** CNAME 記錄後，才能將 A 記錄網域名稱新增至 Azure 網站。
> 
...
此時，您必須能在瀏覽器中輸入自訂網域名稱，並且能成功移至您的 Azure 網站。 <!--HONumber=42-->
