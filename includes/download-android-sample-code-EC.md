...
1. 從 gitHub 下載 `mobile-services-samples` 儲存機制，方法是按一下 <a href="https://github.com/RickSaling/mobile-services-samples/tree/futures" target="blank">[這裡]</a> ，然後按一下 [**下載 ZIP**]。
