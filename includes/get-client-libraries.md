...
<b>注意</b> 
<p>在 Windows 中，您也需要將 Git 可執行檔新增至 PATH 環境變數。</p>
</div>
...
1.  從 [GitHub][] 下載含有程式庫的 .zip 封存檔。或者，分岔儲存機制並複製到本機電腦(後面這個選項需要有 GitHub 帳戶並在本機安裝 Git)。
    ...
    <div class="dev-callout"> 
<b>注意</b> 
<p>PHP Client Libraries for Azure 相依於 <a href="http://pear.php.net/package/HTTP_Request2">HTTP_Request2</a>、<a href="http://pear.php.net/package/Mail_mime">Mail_mime</a> 和 <a href="http://pear.php.net/package/Mail_mimeDecode">Mail_mimeDecode</a> PEAR 封裝。建議使用 <a href="http://pear.php.net/manual/en/installation.php">PEAR 封裝管理員</a>來安裝這些封裝，以解決這些相依性。</p> 
</div>

2.  將已下載之封存檔的`WindowsAzure` 目錄複製到應用程式目錄結構中。

如需關於安裝 PHP Client Libraries for Azure 的詳細資訊 (包括關於以 PEAR 封裝來安裝的詳細資訊)，請參閱＜[下載 Azure SDK for PHP][]＞(英文)。
