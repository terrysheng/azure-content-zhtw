...
MongoLab UI 可讓您執行大部分的資料庫工作，例如插入和查詢文件、取得資料庫統計資料，以及執行實用的資料庫命令。若要深入了解 MongoLab UI，請造訪我們的[支援頁面][支援頁面]和[部落格][部落格]。
...
您可以在這裡選取特定的集合，並向下鑽研個別的文件。完成時，請登出。
  ...
  [支援頁面]: http://support.mongolab.com
  [部落格]: http://blog.mongolab.com
