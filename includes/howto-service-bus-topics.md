...
主題訂閱類似於虛擬佇列，同樣可接收已傳送到主題的訊息複本。您可以選擇為個別訂閱來登錄主題的篩選規則，以篩選/限制主題的哪些訊息可以被哪些主題訂閱接收。

服務匯流排主題和訂閱可讓您擴大處理眾多使用者和應用程式上的龐大訊息。
...
## <a name="obtain-default-credentials"></a>取得命名空間的預設管理認證
