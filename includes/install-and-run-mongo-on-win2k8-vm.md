遵循下列步驟，在執行 Windows Server 2008 R2 的虛擬機器上安裝並執行 MongoDB。
...
11. 在左側窗格中，選取 **內送規則**。在右側的 **動作** 窗格中，選取 **新增規則...**。
    ...
    ![Windows
    防火牆](./media/install-and-run-mongo-on-win2k8-vm/WinFirewall1.png)
    ...
    ![Windows
    防火牆](./media/install-and-run-mongo-on-win2k8-vm/WinFirewall4.png)
    
    再按一下 **下一步**。
    
    ![Windows
    防火牆](./media/install-and-run-mongo-on-win2k8-vm/WinFirewall5.png)
