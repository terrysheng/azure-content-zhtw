...
3.  在您的專案中安裝 Google Play 服務 SDK。在 Eclipse 中，按一下 **[檔案]**，然後按 **[匯入]**。依序選取 **[Android]** 及 **[匯入現有的 Android 程式碼至工作區]**，然後按 **[下一步]**。按一下 **[瀏覽]**，導覽至 Android SDK 路徑 (通常位於名為 `adt-bundle-windows-x86_64` 的資料夾)，然後移至 `\extras\google\google_play_services\libproject` 子資料夾，在該處選取 google-play-services-lib 資料夾，再按一下 **[確定]**。核取 **[將專案複製到工作區]** 核取方塊，再按一下 **[完成]**。
...
7.  在 **[程式庫]** 區段中，選擇 **[新增]**，然後選取 Google Play 服務專案 (*google-play-services-lib*) 並按一下 **[確定]**。
