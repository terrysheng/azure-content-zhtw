...
[開始使用驗證]: ../articles/mobile-services-android-get-started-users.md
[開始使用推播通知]: ../articles/mobile-services-javascript-backend-android-get-started-push.md
