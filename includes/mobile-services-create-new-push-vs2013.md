...
2. 按 [**下一步**]、登入您的 Windows 市集帳戶，接著在 [**保留新名稱**] 中提供名稱，然後按一下 [**保留**]。
...
4. 在 [**選取服務**] 頁面中，按一下您的行動服務名稱，然後按 [**下一步**] 和 [**完成**]。 

	您的行動服務所使用的通知中心已透過 Windows 通知服務 (WNS) 註冊更新。您現在可以使用 Azure 通知中心，透過 WNS 從行動服務傳送通知至您的應用程式。 

	>[WACOM.NOTE]本教學課程示範由行動服務後端傳送通知。您可以使用相同的通知中心註冊，來從任何後端服務傳送通知。如需詳細資訊，請參閱[通知中心概觀](http://msdn.microsoft.com/zh-tw/library/azure/jj927170.aspx)。
