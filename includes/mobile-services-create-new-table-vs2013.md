...
2. 展開 [**進階**]，並驗證資料表操作權限已預設為 [**具有應用程式金鑰的任何人**]，然後按一下 [**建立**]。 
	...
	>[WACOM.NOTE]應用程式金鑰會與應用程式一起散發。因為這個金鑰不會安全地散發，所以無法將它視為安全性 Token。若要確保行動服務資料的存取安全，您必須改在存取之前驗證使用者。如需詳細資訊，請參閱[權限](http://msdn.microsoft.com/zh-tw/library/windowsazure/jj193161.aspx)。
