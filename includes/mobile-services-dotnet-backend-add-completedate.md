在本節中，我們將新增名為 **CompleteDate** 的新時間戳記欄位來修改資料庫的模型。此欄位將記錄前次完成的 Todo 項目時間。Entity Framework 將使用從 [DropCreateDatabaseIfModelChanges](http://go.microsoft.com/fwlink/?LinkId=394621) 衍生的預設資料庫初始設定式類別，根據我們的模型變更來更新資料 
