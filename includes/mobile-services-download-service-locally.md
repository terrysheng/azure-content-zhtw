...
2. 按一下 **[Android]** 平台。在 **[開始使用]** 區段下，展開 **[建立新的 Android 應用程式]**。 
...
4. 在 **[下載並將服務發行至雲端]** 下，按一下 **[下載]**。

	這會下載實作行動服務的 Visual Studio 專案。請將壓縮的專案檔案儲存至本機電腦，並記下儲存位置。


5. 向下捲動至該 **[開始使用]** 區段的底部，找到標題為 **[下載並將服務發行至雲端]** 的步驟。按一下以下螢幕擷取畫面中顯示的連結，以下載您剛剛下載之行動服務的發佈設定檔。 

    > [AZURE.NOTE] 請將此檔案存放在安全位置，因為其中包含與您的 Azure 帳戶有關的敏感資訊。在本教學課程中，您將在發行行動服務後刪除此檔案。 
