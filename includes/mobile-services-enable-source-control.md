...
1. 登入[Azure 管理入口網站]，按一下 [行動服務]****，按一下您的行動服務，然後按一下 [儀表板] ****索引標籤。

	![選取行動服務](./media/mobile-services-enable-source-control/mobile-services-selection.png)
...
3. 提供 [使用者名稱]****、[新密碼]****，並確認密碼，然後按一下核取按鈕。
	...
	![設定原始檔控制認證](./media/mobile-services-enable-source-control/mobile-source-control-credentials.png)
