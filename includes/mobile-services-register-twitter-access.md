...
1.  瀏覽到 [Twitter Developers](http://go.microsoft.com/fwlink/p/?LinkId=268300) 網站，使用您的 Twitter 帳戶認證登入，瀏覽到 **[我的應用程式]** 並選取您的 Twitter 應用程式。

    ![](./media/mobile-services-register-twitter-access/mobile-twitter-my-apps.png)

2.  在應用程式的 **[詳細資料]** 索引標籤中記錄下列值：
...
3.  登入 [Windows Azure 管理入口網站](https://manage.windowsazure.com/)，按一下 **[行動服務]**，然後按您的行動服務。

4.  按一下 **[身分識別]** 索引標籤，輸入從 Twitter 取得的 **[消費者金鑰]** 和 **[消費者密碼]** 值，然後按 **[儲存]**。

    ![](./media/mobile-services-register-twitter-access/mobile-identity-tab-twitter-only.png)

5.  按一下 **[設定]** 索引標籤，向下捲動至 **[應用程式設定]**，並輸入您從 Twitter 網站取得之下列各項的 **[名稱]** 和 **[值]** 組，然後按 **[儲存]**。
