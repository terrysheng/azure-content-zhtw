...
1. 如果尚未執行此操作，請完成<a href="/documentation/articles/mobile-services-how-to-register-twitter-authentication/" target="_blank">在行動服務中註冊您的應用程式以進行 Twitter 登入</a>主題中的步驟。 
...
[在行動服務中註冊您的應用程式以進行 Twitter 登入]:/documentation/articles/mobile-services-how-to-register-twitter-authentication
