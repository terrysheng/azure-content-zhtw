...
8. 在 [服務] 頁面中，按一下 [Azure 行動服務] 下的 [Live 服務網站]。
...
10. (選用) 按一下 [API 設定]，啟用 [增強的重新導向安全性]，在 [重新導向 URL] 中提供  `https://<mobile_service>.azure-mobile.net/login/microsoftaccount` 的值，然後按一下 [儲存]。
