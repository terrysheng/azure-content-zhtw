...
- [(Windows 通用 C# | .NET)](mobile-services-dotnet-backend-windows-store-dotnet-get-started.md)
- [(Windows 通用 C# | Javascript)](mobile-services-javascript-backend-windows-store-dotnet-get-started.md)
- [(Windows 通用 JavaScript | .NET)](mobile-services-dotnet-backend-windows-store-javascript-get-started.md)
- [(Windows 通用 JavaScript | Javascript)](mobile-services-javascript-backend-windows-store-javascript-get-started.md)
