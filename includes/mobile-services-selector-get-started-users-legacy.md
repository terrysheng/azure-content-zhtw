...
- [(Windows 市集 C# | .NET)](../articles/mobile-services-dotnet-backend-windows-store-dotnet-get-started-users.md)
- [(Windows 市集 C# | Javascript)](../articles/mobile-services-windows-store-dotnet-get-started-users.md)
- [(Windows 市集 JavaScript | Javascript)](../articles/mobile-services-windows-store-javascript-get-started-users.md)
