...
3. 在 MainPage.xaml.cs 中，將定義現有項目集合的行註解化或予以刪除，然後取消註解或新增下列行，並使用將專案連線到行動服務時新增到 App.xaml.cs 檔案的  `MobileServiceClient` 欄位來取代 _&lt;yourClient&gt;_： 
...
4. 在 **InsertTodoItem** 方法中，移除設定 **TodoItem.Id** 屬性的程式碼行，將 **async** 修飾詞新增至方法，並取消註解下列程式碼行： 
...
6. 在 **UpdateCheckedTodoItem** 方法中，將 **async** 修飾詞新增至方法，並取消註解下列程式碼行： 
