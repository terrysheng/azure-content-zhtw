...
1.  在 Visual Studio 2012 Express for Windows Phone，開啟快速入門專案中的 MainPage.xaml 檔案，尋找名為 `ButtonRefresh` 的 **Button** 元素，並使用下列 XAML 程式碼取代它：
