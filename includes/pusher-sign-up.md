...
6.  在您的 Azure 設定中輸入一個可識別 **Pusher** 服務的名稱，或使用 **Pusher**
...
9.  在 **檢閱購買項目**
    索引標籤中，檢閱方案和價格資訊，並檢閱法律條款。如果您同意接受這些條款，請按一下核取記號。按一下核取記錄之後，您的 Pusher
    帳戶將會開始佈建程序。
...
系統會立即佈建您的 Pusher 帳戶，您將會看到 **已成功購買附加元件 Pusher**
的訊息。現在已建立好帳戶，您已準備好開始使用 Pusher 服務。
...
2.  在 *[連線資訊]* 對話方塊中，您將會看到您的應用程式
    ID、金鑰和密碼。您稍後會在本教學課程中使用這些值，所以請進行複製以供稍後使用。
