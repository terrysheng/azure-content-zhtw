Azure 客戶每月可以解除鎖定 25,000 封免費電子郵件。這些每月 25,000 封的免費電子郵件可讓您存取進階報告與分析及所有 API (Web、SMTP、Event、Parse、Sub-User)。如需有關 SendGrid 所提供其他服務的資訊，請參閱 [SendGrid 功能][]頁面。
...
[SendGrid 佈建程序]: https://support.sendgrid.com/hc/zh-tw/articles/200181628-Why-is-my-account-being-provisioned-
