...
1. 從 [[Qpid AMQP Messenger](http://qpid.apache.org/components/messenger/index.html)] 頁面中，按一下 [**安裝 Qpid Proton**] 連結，並遵循指示進行 (視您的環境而定)。我們將假設是 Linux 環境 (例如含 Ubuntu 14.04 的 [Azure Linux VM](http://azure.microsoft.com/documentation/articles/virtual-machines-linux-tutorial/))。
