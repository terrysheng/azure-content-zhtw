<properties
   pageTitle="安裝維護模式 Hotfix"
   description="說明如何使用 Windows PowerShell for StorSimple 來安裝維護模式 Hotfix。"
   services="storsimple"
...
1. 使裝置處於維護模式。如需如何進入維護模式的相關指示，請參閱＜變更裝置模式＞。
...
6. 套用 Hotfix 之後，結束維護模式。如需相關指示，請參閱[結束維護模式](#to-exit-maintenance-mode)。
