...
> [AZURE.NOTE] 雲端服務不存在於 Azure 資源管理員中。如需資源管理員優點的介紹，請參閱〈[Azure 資源管理員提供的 Azure 運算、網路和儲存體提供者](../articles/virtual-machines/virtual-machines-windows-compare-deployment-models.md)〉。
